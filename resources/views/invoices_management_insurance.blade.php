        ...
        margin-top: 4px;">
              ...
              <div class="tab">
                    ...
                    @if ($category=='Real Estate only' OR $category=='All')
                        <button class="tablinks  space_identity" onclick='javascript:window.location.href="/invoice_management"' ><strong>Real Estate</strong></button>
                    @else
                    @endif


                    @if($category=='Research Flats only' OR $category=='All')
                            <button class="tablinks research_identity" onclick='javascript:window.location.href="/invoice_management/research"'><strong>Research Flats</strong></button>
                        @else
                        @endif
                    ...
                    @if($category=='Insurance only' OR $category=='All')
                        <button class="tablinks active insurance_identity" onclick='javascript:window.location.href="/invoice_management/insurance"'><strong>Insurance</strong></button>
                    ...
                    @if ($category=='CPTU only' OR $category=='All')
                        <button class="tablinks car_identity" onclick='javascript:window.location.href="/invoice_management/car_rental"'><strong>Car Rental</strong></button>
                    @else
                    @endif
                    ...
                    <div id="insurance_invoices" class="">

                    <br>
                    <div class="tab" style="">

                        <button class="tablinks_inner_insurance " onclick="openInnerInvoicesInsurance(event, 'insurance_category_clients')" id="defaultOpenInsuranceClientsCategory"><strong>Clients</strong></button>
                        <button class="tablinks_inner_insurance " onclick="openInnerInvoicesInsurance(event, 'insurance_category_principals')"><strong>Principals</strong></button>

                    </div>


                    <div id="insurance_category_clients"  class="tabcontent_inner_insurance">


                        @if(Auth::user()->role=='Accountant-DPDI' || Auth::user()->role=='Insurance Officer')

                            <div id="insurance_clients_invoices_inner" style="  ">
                                ...
                                @if(Auth::user()->role=='Accountant-DPDI' || Auth::user()->role=='Insurance Officer')
                                    ...
                                    <div class="tab" style="">
                                        ...
                                        <button class="tablinks_inner_insurance_clients " onclick="openDeepInnerinsurance_clients(event, 'insurance_clients_invoice_inbox')" id="defaultOpenInnerinsurance_clients"><strong>Inbox</strong></button>
                                        <button class="tablinks_inner_insurance_clients " onclick="openDeepInnerinsurance_clients(event, 'insurance_clients_invoice_outbox')"><strong>Outbox</strong></button>
                                        <button class="tablinks_inner_insurance_clients " onclick="openDeepInnerinsurance_clients(event, 'insurance_clients_complete_invoices')"><strong>Invoices</strong></button>
                                    </div>



                                    @if(Auth::user()->role=='Accountant-DPDI')
                                        {{--                      insurance_clients invoice  inbox start--}}
                                        <div  id="insurance_clients_invoice_inbox" style="border-bottom-left-radius: 50px 20px;   border: 1px solid #ccc; padding: 1%;" class="tabcontent_inner_insurance_clients">
                                            <br>

                                            @if($insurance_clients_invoice_inbox!='')

                                                <div style="float:right; margin-bottom: 1%;"><a data-toggle="modal" class="btn button_color active" style="background-color: #38c172; padding: 7px; color:white; margin-left: -2px;  margin-bottom: 5px; margin-top: 4px;"  data-target="#send_invoice_insurance_clients"  role="button" aria-pressed="true"><i class="fa fa-envelope" aria-hidden="true"></i> Send All Invoices</a></div>
                                     <div class="modal fade" id="send_invoice_insurance_clients" role="dialog">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form method="get" action="{{ route('send_all_invoices_insurance')}}">
                                                {{csrf_field()}}

                                                <div align="right">
                                                    <button id="send_all_insurance" class="btn btn-primary" type="submit" id="newdata">Send</button>
                                            ...
                                            @if($insurance_clients_invoice_inbox!='')
                                                ...
                                                <div  id="">
                                                    ...
                                                    <table class="table">
                                                        ...
                                                        @foreach($insurance_clients_invoice_inbox as $var)
                                                            <tr>
                                                    ...
                                                    @if($var->email_sent_status=='NOT SENT')
                                                        ...
                                                        @else
                                                            ...
                                                            @if($var->gepg_control_no=='')
                                                                <a title="Add invoice and GePG control numbers" data-toggle="modal" style="color: #3490dc; cursor: pointer;"  data-target="#add_control_number_insurance{{$var->invoice_number}}"  role="button" aria-pressed="true" name="editC"><i class="fas fa-file-medical"></i></a>
                                                                        ...
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <form method="post" action="{{ route('add_control_no_insurance',$var->invoice_number)}}"  id="form1" >
                                                                                    ...
                                                                                    <br>
                                                                                    <div align="right">
                                                                                        <button id="sendbtn_insurance_all{{$var->invoice_number}}" class="btn btn-primary" type="submit">Save</button>
                                                                                        <button class="btn btn-danger" type="button" class="close" data-dismiss="modal">Cancel</button>
                                                                                    </div>
                                                                                </form>
                                        ...
                                        {{--                      insurance_clients invoice  inbox end--}}
                                    @else
                                        {{--                      insurance_clients invoice  inbox start--}}
                                        <div  id="insurance_clients_invoice_inbox" style="border-bottom-left-radius: 50px 20px;   border: 1px solid #ccc; padding: 1%;" class="tabcontent_inner_insurance_clients">
                                            <br>
                                                        ...
                                                        @foreach($insurance_clients_invoice_inbox as $var)
                                                            <tr>
                                                                ...
                                                                <td><center>
                                                                      ...
                                                                      <a title="View contract" style="color:#3490dc !important; display:inline-block;"  class="" data-toggle="modal" data-target="#contract_insurance_clients{{$var->invoice_number}}" style="cursor: pointer;" aria-pressed="true"><i class="fa fa-file-text" aria-hidden="true"></i></a>
                                                    <div class="modal fade" id="contract_insurance_clients{{$var->invoice_number}}" role="dialog">
                        ...
                        @endif
                                                                    ...
                                                                    <center><button class="btn btn-danger" type="button" class="close" data-dismiss="modal">Close</button></center>
                                                                        ...
                                                                        <a  title="Forward invoice" style="color:#3490dc !important; display:inline-block;"  class="" data-toggle="modal" data-target="#invoice_foward_insurance_clients{{$var->invoice_number}}" style="cursor: pointer;" aria-pressed="true"><center><i class="fas fa-arrow-alt-circle-right"></i></center></a>
                                                                        <div class="modal fade" id="invoice_foward_insurance_clients{{$var->invoice_number}}" role="dialog">

                                                                            <div class="modal-dialog" role="document">
                                                                                <div class="modal-content">
                                                                                    <div class="modal-header">
                                                                                        <b><h5 class="modal-title">Forwarding invoice to Accountant</h5></b>
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        ...
                                                                                        <form method="post" action="{{ route('foward_insurance_clients_invoice',$var->invoice_number)}}"  id="form1" >
                                                                                            {{csrf_field()}}
                                                                                            ...
                                                                                            <div class="form-row">
                                                                                                ...
                                                                                                <div  class="form-group col-md-12 mt-1">
                                                                                                    <div class="form-wrapper">
                                                                                                        ...
                                                                                                        <input type="text" class="form-control"  name="debtor_address" value="{{$var->debtor_address}}"   autocomplete="off">
                                                                                                    </div>
                                                                                                </div>
...
{{--                                                                                                </div>--}}
                                                                                                ...
                                                                                                <div  class="form-group col-md-12 mt-1">
                                                                                                    <div class="form-wrapper">
                                                                                                        ...
                                                                                                        <input type="text" class="form-control" id="" name="period" value="{{$var->period}}"  required  autocomplete="off">
                                                                                                    </div>
                                                                                                </div>
                                                                                                ...
                                                                                                <div   class="form-group col-md-12 mt-1">
                                                                                                    <div class="form-wrapper">
                                                                                                        ...
                                                                                                        <input type="text" class="form-control" id="" name="project_id" value="{{$var->project_id}}" Required autocomplete="off">
                                                                                                    </div>
                                                                                                </div>
                                                                                                ...
                                                                                                <div   class="form-group col-md-6 mt-1">
                                                                                                    <div class="form-wrapper">
                                                                                                        ...
                                                                                                        <input type="number" min="20" class="form-control" id="" name="amount_to_be_paid" value="{{$var->amount_to_be_paid}}" Required  autocomplete="off">
                                                                                                    </div>
                                                                                                </div>
                                                                                                    ...
                                                                                                    <div  class="form-wrapper">
                                                                                                        <select id="" class="form-control" required name="currency">
                                                                                                            @if($var->currency_invoice=='TZS')
                                                                                                                <option value="{{$var->currency_invoice}}" selected>{{$var->currency_invoice}}</option>
                                                                                                                <option value="USD" >USD</option>
                                                                                                            @elseif($var->currency_invoice=='USD')
                                                                                                                <option value="{{$var->currency_invoice}}" selected>{{$var->currency_invoice}}</option>
                                                                                                ...
                                                                                                <div  class="form-group col-md-12 mt-1">
                                                                                                    <div class="form-wrapper">
                                                                                                        ...
                                                                                                        <input type="text" class="form-control" id="" name="status" value="{{$var->status}}" required  autocomplete="off">
                                                                                                    </div>
                                                                                                </div>
                                                                                                ...
                                                                                                <div  class="form-group col-md-12 mt-1">
                                                                                                    <div class="form-wrapper">
                                                                                                        ...
                                                                                                        <input type="text" class="form-control" id="" name="description" value="{{$var->description}}" required  autocomplete="off">
                                                                                                    </div>
                                                                                                </div>
                                                                                            ...
                                                                                            <div align="right">
                                                                                                <button id="submit_insurance_clients" class="btn btn-primary" type="submit">Foward</button>
                                                                                                <button class="btn btn-danger" type="button" class="close" data-dismiss="modal">Cancel</button>
                                                                                            </div>
                                                                                        </form>
                                    ...
                                    {{--     insurance_clients invoice outbox start--}}
                                    @if(Auth::user()->role=='Insurance Officer')
                                        <div  id="insurance_clients_invoice_outbox" style="border-bottom-left-radius: 50px 20px;   border: 1px solid #ccc; padding: 1%;" class="tabcontent_inner_insurance_clients">
                                            <br>
                                            ...
                                            @if($insurance_clients_invoice_outbox!='')
                                                ...
                                                <div>
                                                    ...
                                                    <table class=" table ">
                                                        ...
                                                        @foreach($insurance_clients_invoice_outbox as $var)
                                                            <tr>
                                                                ...
                                                                <td><center>{{date("d/m/Y",strtotime($var->invoicing_period_end_date))}}</center></td>
                                                                <td><center>{{number_format($var->amount_to_be_paid)}} {{$var->currency_invoice}}</center></td>
                                                                <td><center>Accountant-DPDI</center></td>
                                        ...
                                        <div id="insurance_clients_invoice_outbox" style="border-bottom-left-radius: 50px 20px;   border: 1px solid #ccc; padding: 1%;" class="tabcontent_inner_insurance_clients">
                                            ...
                                            @if($insurance_clients_invoice_outbox!='')
                                                ...
                                                <div id="">
                                                    ...
                                                    <a title="View invoice" style="color:#3490dc !important; display:inline-block;"  class="" data-toggle="modal" data-target="#invoice_insurance_clients_outbox{{$var->invoice_number}}" style="cursor: pointer;" aria-pressed="true"><center><i class="fa fa-eye" aria-hidden="true" style="font-size: 20px;"></i></center></a>
                                                    <div class="modal fade" id="invoice_insurance_clients_outbox{{$var->invoice_number}}" role="dialog">
                                                    ...
                                                    @if($var->email_sent_status=='NOT SENT')
                                                        ...
                                                        @else
                                                            ...
                                                            @if($var->gepg_control_no=='')
                                                                <a title="Add invoice and GePG control numbers" data-toggle="modal" style="color: #3490dc; cursor: pointer;"  data-target="#add_control_number_insurance_clients_outbox{{$var->invoice_number}}"  role="button" aria-pressed="true" name="editC"><i class="fas fa-file-medical"></i></a>
                                                                <div class="modal fade" id="add_control_number_insurance_clients_outbox{{$var->invoice_number}}" role="dialog">
                                                            ...
                                                            <a title="Send invoice" data-toggle="modal" style=" color: #3490dc; cursor: pointer;"  data-target="#send_invoice_insurance_clients_outbox{{$var->invoice_number}}"  role="button" aria-pressed="true" name="editC"><i class="fa fa-envelope" aria-hidden="true"></i></a>
                                                                <div class="modal fade" id="send_invoice_insurance_clients_outbox{{$var->invoice_number}}" role="dialog">
                                                    ...
                                                    @if($var->email_sent_status=='SENT')
                                                        ...
                                                        @else
                                                            @if($var->payment_status=='Not paid')
                                                                <a title="Receive payment" data-toggle="modal" data-target="#add_comment_insurance_clients_outbox{{$var->invoice_number}}"  role="button" aria-pressed="true"   name="editC"><i class="fa fa-money" style="font-size:20px; color:#3490dc !important;" aria-hidden="true"></i></a>

                                                                <div class="modal fade" id="add_comment_insurance_clients_outbox{{$var->invoice_number}}" role="dialog">
                                    ...
                                    {{--                        insurance_clients invoice outbox end--}}


                                    {{--Complete insurance_clients invoices start--}}
                                    <div id="insurance_clients_complete_invoices" style="border-bottom-left-radius: 50px 20px;   border: 1px solid #ccc; padding: 1%;" class="tabcontent_inner_insurance_clients">
{{--                                        <br>--}}

{{--                                        <h3 style="text-align: center"><strong>Insurance invoices(clients)</strong></h3>--}}
                                                ...
                                                <div class="pull-right">
                                                    <form class="form-inline" role="form" method="post" accept-charset="utf-8">
                                                        ...
                                                        <div class="form-group"  style="margin-right: -13px;">
                                                            <input type="submit" name="filter" value="Filter" id="insurance_clients_filter" class="btn btn-primary">
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                                            <div id="insurance_clients_content">

                                                <table class="hover table table-striped  table-bordered" id="myTableInsuranceClients">
                                                    ...
                                                    @foreach($insurance_clients_invoices as $var)
                                                        <tr>
                                                    ...
                                                    <a title="View invoice" style="color:#3490dc !important; display:inline-block; cursor: pointer;"  class="" data-toggle="modal" data-target="#invoice_insurance_clients{{$var->invoice_number}}"  aria-pressed="true"><i class="fa fa-eye" style="font-size: 20px;" aria-hidden="true"></i></a>
                                                    <div class="modal fade" id="invoice_insurance_clients{{$var->invoice_number}}" role="dialog">
...
<a title="Print this invoice" href="{{ route('print_insurance_invoice_clients',$var->invoice_number) }}"><i class="fa fa-print" aria-hidden="true"></i></a>
                                                            ...
                                                            <a title="Cancel this invoice" data-toggle="modal" data-target="#cancel_insurance_invoice_clients{{$var->invoice_number}}" role="button" aria-pressed="true"><i class="fa fa-times" aria-hidden="true" style=" color:red;"></i></a>
                                                             ...
                                                             <div class="modal-dialog" role="document">
                                                                 <div class="modal-content">
                                                                     <div class="modal-header">
                                                                         <b><h5 class="modal-title">Are you sure you want to cancel invoice number {{$var->invoice_number_votebook}}?</h5></b>

                                                                         <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                                     </div>

                                                                     <div class="modal-body">
                                                                         <form method="post" action="{{ route('cancel_insurance_invoice_clients',$var->invoice_number)}}" >
                                                                             {{csrf_field()}}
                                    ...
                                    {{--complete insurance_clients invoices end--}}
                                @else
                                    <div id="">
{{--                                    <br>--}}
...
<a title="Print this invoice" href="{{ route('print_insurance_invoice_clients',$var->invoice_number) }}"><i class="fa fa-print" aria-hidden="true"></i></a>
                        ...
                        @else
                            <div id="insurance_clients_invoices_inner" style="border: 1px solid #ccc; padding: 1%; border-bottom-left-radius: 50px 20px; " >
...
<a title="Print this invoice" href="{{ route('print_insurance_invoice_clients',$var->invoice_number) }}"><i class="fa fa-print" aria-hidden="true"></i></a>
                    ...
                    <div id="insurance_category_principals"  class="tabcontent_inner_insurance">

                        @if(Auth::user()->role=='Accountant-DPDI' || Auth::user()->role=='Insurance Officer')

                            <div id="insurance_invoices_inner" style="  ">
                                ...
                                @if(Auth::user()->role=='Accountant-DPDI' || Auth::user()->role=='Insurance Officer')
                                    ...
                                    <div class="tab" style="">
                                        ...
                                        <button class="tablinks_deep_inner_insurance " onclick="openDeepInnerinsurance(event, 'insurance_invoice_inbox')" id="defaultOpenDeepInnerinsurance"><strong>Inbox</strong></button>
                                        <button class="tablinks_deep_inner_insurance " onclick="openDeepInnerinsurance(event, 'insurance_invoice_outbox')"><strong>Outbox</strong></button>
                                        <button class="tablinks_deep_inner_insurance " onclick="openDeepInnerinsurance(event, 'insurance_complete_invoices')"><strong>Invoices</strong></button>
                                    </div>



                                    @if(Auth::user()->role=='Accountant-DPDI')
                                        {{--                      insurance invoice  inbox start--}}
                                        <div  id="insurance_invoice_inbox" style="border-bottom-left-radius: 50px 20px;   border: 1px solid #ccc; padding: 1%;" class="tabcontent_deep_inner_insurance">
                                            <br>

                                            @if($insurance_invoice_inbox!='')

                                                <div style="float:right; margin-bottom: 1%;"><a data-toggle="modal" class="btn button_color active" style="background-color: #38c172; padding: 7px; color:white; margin-left: -2px;  margin-bottom: 5px; margin-top: 4px;"  data-target="#send_invoice_insurance_principals"  role="button" aria-pressed="true"><i class="fa fa-envelope" aria-hidden="true"></i> Send All Invoices</a></div>
                                 <div class="modal fade" id="send_invoice_insurance_principals" role="dialog">

                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <b><h5 class="modal-title">Sending all invoices to respective principals</h5></b>

                                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                                        </div>

                                        <div class="modal-body">
                                            <form method="get" action="{{ route('send_all_invoices_principals_insurance')}}" >
                                                {{csrf_field()}}
                                            ...
                                            @if($insurance_invoice_inbox!='')
                                                ...
                                                <div  id="">
                                                    ...
                                                    <table class="table">
                                                        ...
                                                        @foreach($insurance_invoice_inbox as $var)
                                                            <tr>
                           ...
                           <td><center>
                                                    ...
                                                    <a title="View invoice" style="color:#3490dc !important; display:inline-block;"  class="" data-toggle="modal" data-target="#invoice_insurance_principals{{$var->invoice_number}}" style="cursor: pointer;" aria-pressed="true"><center><i class="fa fa-eye" aria-hidden="true" style="font-size: 20px;"></i></center></a>
                                                    ...
                                                    @if($var->email_sent_status=='NOT SENT')
                                                        ...
                                                        @else
                                                            ...
                                                            @if($var->gepg_control_no=='')
                                                                <a title="Add invoice and GePG control numbers" data-toggle="modal" style="color: #3490dc; cursor: pointer;"  data-target="#add_control_number_insurance_principals{{$var->invoice_number}}"  role="button" aria-pressed="true" name="editC"><i class="fas fa-file-medical"></i></a>
                                                                <div class="modal fade" id="add_control_number_insurance_principals{{$var->invoice_number}}" role="dialog">
                                                                    ...
                                                                    <div class="modal-dialog" role="document">
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <form method="post" action="{{ route('add_control_no_insurance_principals',$var->invoice_number)}}"  id="form1" >
                                                                                    {{csrf_field()}}
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        <div class="form-wrapper">
                                                                                            ...
                                                                                            <input id="gepg_principals{{$var->invoice_number}}" type="number" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength); minControlInsuranceAllPrincipals(this.value,{{$var->invoice_number}});" maxlength = "12" class="form-control" id="course_name" name="gepg_control_no" value="" Required autocomplete="off">
                                                                                            <p id="error_gepg_insurance_all_principals{{$var->invoice_number}}"></p>
                                                                                    ...
                                                                                    <br>
                                                                                    <div align="right">
                                                                                        <button id="sendbtn_insurance_all_principals{{$var->invoice_number}}" class="btn btn-primary" type="submit">Save</button>
                                                                                        <button class="btn btn-danger" type="button" class="close" data-dismiss="modal">Cancel</button>
                                                                                    </div>
                                                                                </form>
                                                            ...
                                                            <a title="Send invoice" data-toggle="modal" style=" color: #3490dc; cursor: pointer;"  data-target="#send_invoice_insurance_principals{{$var->invoice_number}}"  role="button" aria-pressed="true" name="editC"><i class="fa fa-envelope" aria-hidden="true"></i></a>
                                                                <div class="modal fade" id="send_invoice_insurance_principals{{$var->invoice_number}}" role="dialog">
                                                                    ...
                                                                    <div class="modal-dialog" role="document">
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <form method="post" action="{{ route('send_invoice_insurance_principals',$var->invoice_number)}}"  id="form1" >
                                                                                    {{csrf_field()}}
                                                                                    ...
                                                                                    @if($var->gepg_control_no=='')
                                                                                        <div class="form-group">
                                                                                            <div class="form-wrapper">
                                                                                                <label for="course_name">GePG Control Number <span style="color: red;">*</span></label>
                                                                                                <input id="gepg_principals{{$var->invoice_number}}"  type="number" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength); minControlInsurancePrincipals(this.value,{{$var->invoice_number}});" maxlength = "12" class="form-control" id="course_name" name="gepg_control_no" value="" Required autocomplete="off">
                                                                                                <p id="error_gepg_insurance_principals{{$var->invoice_number}}"></p>
                                                                                            </div>
                                                                                        </div>
                                                                                    @else
                                                                                        <div class="form-group">
                                                                                            <div class="form-wrapper">
                                                                                                <label for="course_name">GePG Control Number <span style="color: red;">*</span></label>
                                                                                                <input id="gepg_principals{{$var->invoice_number}}" readonly type="number" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength); minControlInsurancePrincipals(this.value,{{$var->invoice_number}});" maxlength = "12" class="form-control" id="course_name" name="gepg_control_no" value="{{$var->gepg_control_no}}" autocomplete="off">
                                                                                    ...
                                                                                    <br>
                                                                                    <div align="right">
                                                                                        <button id="sendbtn_insurance_principals{{$var->invoice_number}}" class="btn btn-primary" type="submit">Send</button>
                                                                                        <button class="btn btn-danger" type="button" class="close" data-dismiss="modal">Cancel</button>
                                                                                    </div>
                                                                                </form>
                                                    ...
                                                    @if($var->email_sent_status=='SENT')
                                                        ...
                                                        @else
                                                            @if($var->payment_status=='Not paid')
                                                                <a title="Receive payment" data-toggle="modal" data-target="#add_comment_insurance_principals{{$var->invoice_number}}"  role="button" aria-pressed="true"   name="editC"><i class="fa fa-money" style="font-size:20px; color:#3490dc !important;" aria-hidden="true"></i></a>
                                                                <div class="modal fade" id="add_comment_insurance_principals{{$var->invoice_number}}" role="dialog">
                                                                    ...
                                                                    <div class="modal-dialog" role="document">
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <form method="post" action="{{ route('change_payment_status_insurance_principals',$var->invoice_number)}}"  id="form1" >
                                                                                    {{csrf_field()}}
                                                                                    <div style="text-align: left;" class="form-row">
                                                        ...
                                                        @foreach($insurance_invoice_inbox as $var)
                                                            <tr>
                                                                ...
                                                                <td><center>
                                                                        ...
                                                                        <a  title="Forward invoice" style="color:#3490dc !important; display:inline-block;"  class="" data-toggle="modal" data-target="#invoice_foward_insurance{{$var->invoice_number}}" style="cursor: pointer;" aria-pressed="true"><center><i class="fas fa-arrow-alt-circle-right"></i></center></a>
                                                                        <div class="modal fade" id="invoice_foward_insurance{{$var->invoice_number}}" role="dialog">
                                                                            ...
                                                                            <div class="modal-dialog" role="document">
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        ...
                                                                                        <form method="post" action="{{ route('foward_insurance_invoice',$var->invoice_number)}}"  id="form1" >
                                                                                            {{csrf_field()}}
...
<div class="form-group col-md-6 mt-1"  style="display: none;" id="debtor_account_code_insuranceDiv">
                                                        <div class="form-wrapper">
                                                            ...
                                                            <input type="text" class="form-control" id="debtor_account_code_insurance" readonly name="debtor_account_code" value="{{$var->debtor_account_code}}"  autocomplete="off">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group col-md-12 mt-1" style="display: none;" id="debtor_address_insuranceDiv">
                                                        <div class="form-wrapper">
                                                            ...
                                                            <input type="text" class="form-control" id="debtor_address_insurance" name="debtor_address" value="{{$var->debtor_address}}" readonly Required autocomplete="off">
                                                        </div>
                                                    </div>
...
{{--                                                                                                </div>--}}
                                                                                            ...
                                                                                            <div align="right">
                                                                                                <button id="submit_insurance" class="btn btn-primary" type="submit">Foward</button>
                                                                                                <button class="btn btn-danger" type="button" class="close" data-dismiss="modal">Cancel</button>
                                                                                            </div>
                                                                                        </form>
                                    ...
                                    {{--     insurance invoice outbox start--}}
                                    @if(Auth::user()->role=='Insurance Officer')
                                        <div  id="insurance_invoice_outbox" style="border-bottom-left-radius: 50px 20px;   border: 1px solid #ccc; padding: 1%;" class="tabcontent_deep_inner_insurance">
                                            <br>
                                            ...
                                            @if($insurance_invoice_outbox!='')
                                                ...
                                                <div>
                                                    ...
                                                    <table class=" table ">
                                                        ...
                                                        @foreach($insurance_invoice_outbox as $var)
                                                            <tr>
                                        ...
                                        <div id="insurance_invoice_outbox" style="border-bottom-left-radius: 50px 20px;   border: 1px solid #ccc; padding: 1%;" class="tabcontent_deep_inner_insurance">
                                            ...
                                            @if($insurance_invoice_outbox!='')
                                                ...
                                                <div id="">
                                                    ...
                                                    <a title="View invoice" style="color:#3490dc !important; display:inline-block;"  class="" data-toggle="modal" data-target="#invoice_insurance_principals_outbox{{$var->invoice_number}}" style="cursor: pointer;" aria-pressed="true"><center><i class="fa fa-eye" aria-hidden="true" style="font-size: 20px;"></i></center></a>
                                                    <div class="modal fade" id="invoice_insurance_principals_outbox{{$var->invoice_number}}" role="dialog">
                                                    ...
                                                    @if($var->email_sent_status=='NOT SENT')
                                                        ...
                                                        @else
                                                            ...
                                                            @if($var->gepg_control_no=='')
                                                                <a title="Add invoice and GePG control numbers" data-toggle="modal" style="color: #3490dc; cursor: pointer;"  data-target="#add_control_number_insurance_principals_outbox{{$var->invoice_number}}"  role="button" aria-pressed="true" name="editC"><i class="fas fa-file-medical"></i></a>
                                                                <div class="modal fade" id="add_control_number_insurance_principals_outbox{{$var->invoice_number}}" role="dialog">
                                                            ...
                                                            <a title="Send invoice" data-toggle="modal" style=" color: #3490dc; cursor: pointer;"  data-target="#send_invoice_insurance_principals_outbox{{$var->invoice_number}}"  role="button" aria-pressed="true" name="editC"><i class="fa fa-envelope" aria-hidden="true"></i></a>
                                                                <div class="modal fade" id="send_invoice_insurance_principals_outbox{{$var->invoice_number}}" role="dialog">
                                                    ...
                                                    @if($var->email_sent_status=='SENT')
                                                        ...
                                                        @else
                                                            @if($var->payment_status=='Not paid')
                                                                <a title="Receive payment" data-toggle="modal" data-target="#add_comment_insurance_principals_outbox{{$var->invoice_number}}"  role="button" aria-pressed="true"   name="editC"><i class="fa fa-money" style="font-size:20px; color:#3490dc !important;" aria-hidden="true"></i></a>
                                                                <div class="modal fade" id="add_comment_insurance_principals_outbox{{$var->invoice_number}}" role="dialog">
                                    ...
                                    {{--                        insurance invoice outbox end--}}


                                    {{--Complete insurance invoices start--}}
                                    <div id="insurance_complete_invoices" style="border-bottom-left-radius: 50px 20px;   border: 1px solid #ccc; padding: 1%;" class="tabcontent_deep_inner_insurance">
{{--                                        <br>--}}

{{--                                        <h3 style="text-align: center"><strong>Insurance invoices(Principals)</strong></h3>--}}
...
{{--                                        <hr>--}}
                         ...
                         <div class="modal fade" id="new_invoice_insurance" role="dialog">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <b><h5 class="modal-title">Create New Insurance Invoice(For principals)</h5></b>
...
{{--                                                    <div id="invoice_number_insuranceDiv" style="display: none;" class="form-group col-md-12">--}}
{{--                                                        <div class="form-wrapper">--}}
{{--                                                            <label for="">Invoice number <span style="color: red;">*</span></label>--}}
...
{{--                                                    </div>--}}
                                                    ...
                                                    <div class="form-group col-md-6 mt-1"  style="display: none;" id="debtor_account_code_insurance2Div">
                                                        <div class="form-wrapper">
                                                            <label for=""  >Principal Account Code</label>
                                                            <input type="text" class="form-control" id="debtor_account_code_insurance"   name="debtor_account_code" value=""  autocomplete="off">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group col-md-6 mt-1" style="display: none;" id="tin_insurance2Div">
                                                        <div class="form-wrapper">
                                                            <label for=""  >Principal TIN</label>
                                                            <input type="text" class="form-control" id="tin_insurance" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength); minCharacters(this.value);" maxlength = "9" name="tin" value=""  autocomplete="off">
                                                            <p id="error_tin"></p>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group col-md-12 mt-1" style="display: none;" id="debtor_address_insurance2Div">
                                                        <div class="form-wrapper">
                                                            <label for=""  >Principal Address <span style="color: red;">*</span></label>
                                                            <input type="text" class="form-control" id="debtor_address_insurance" name="debtor_address" value=""  Required autocomplete="off">
                                                        </div>
                                                    </div>
...
{{--                                                    </div>--}}
                                                ...
                                                <div align="right">
                                                    <button id="submit_insurance_principals" class="btn btn-primary" type="submit">Submit</button>
                                                    <button class="btn btn-danger" type="button" class="close" data-dismiss="modal">Cancel</button>
                                                </div>
                                            </form>
...
<a title="Print this invoice" href="{{ route('print_insurance_invoice_principals',$var->invoice_number) }}"><i class="fa fa-print" aria-hidden="true"></i></a>
                                                            ...
                                                            <a title="Cancel this invoice" data-toggle="modal" data-target="#cancel_insurance_invoice_principals{{$var->invoice_number}}" role="button" aria-pressed="true"><i class="fa fa-times" aria-hidden="true" style=" color:red;"></i></a>
                                                             ...
                                                             <div class="modal-dialog" role="document">
                                                                 <div class="modal-content">
                                                                     ...
                                                                     <div class="modal-body">
                                                                         <form method="post" action="{{ route('cancel_insurance_invoice_principals',$var->invoice_number)}}" >
                                                                             {{csrf_field()}}
                                    ...
                                    {{--complete insurance invoices end--}}
                                @else
                                    <div id="">
{{--    <br>--}}
...
<a title="Print this invoice" href="{{ route('print_insurance_invoice_principals',$var->invoice_number) }}"><i class="fa fa-print" aria-hidden="true"></i></a>
                        ...
                        @else
                            <div id="insurance_invoices_inner" style="border: 1px solid #ccc; padding: 1%; border-bottom-left-radius: 50px 20px; " >
...
@section('pagescript')
    <script>
        ...
        function minControlInsurancePrincipals(value,id){



            if(value.length<12){

                document.getElementById("sendbtn_insurance_principals"+id).disabled = true;
                document.getElementById("error_gepg_insurance_principals"+id).style.color = 'red';
                document.getElementById("error_gepg_insurance_principals"+id).style.float = 'left';
                document.getElementById("error_gepg_insurance_principals"+id).style.paddingTop = '1%';
                document.getElementById("error_gepg_insurance_principals"+id).innerHTML ='GePG Control number cannot be less than 12 digits';

            }else{
                document.getElementById("error_gepg_insurance_principals"+id).innerHTML ='';
                document.getElementById("sendbtn_insurance_principals"+id).disabled = false;
            }
        ...
        function minControlResearch(value,id){



            if(value.length<12){

                document.getElementById("sendbtn_research"+id).disabled = true;
                document.getElementById("error_gepg_research"+id).style.color = 'red';
                document.getElementById("error_gepg_research"+id).style.float = 'left';
                document.getElementById("error_gepg_research"+id).style.paddingTop = '1%';
                document.getElementById("error_gepg_research"+id).innerHTML ='GePG Control number cannot be less than 12 digits';

            }else{
                document.getElementById("error_gepg_research"+id).innerHTML ='';
                document.getElementById("sendbtn_research"+id).disabled = false;
            }
        ...
        function minControlAll(value,id){



            if(value.length<12){

                document.getElementById("sendbtn_all"+id).disabled = true;
                ...
                document.getElementById("sendbtn_all"+id).disabled = false;
            }

        }


        function minControlInsuranceAll(value,id){



            if(value.length<12){

                document.getElementById("sendbtn_insurance_all"+id).disabled = true;
        ...
        function minControlWaterAll(value,id){
            ...
            if(value.length<12){
                ...
                document.getElementById("sendbtn_water_all"+id).disabled = true;
                ...
                document.getElementById("sendbtn_water_all"+id).disabled = false;
            }

        }

        function minControlElectricityAll(value,id){
            console.log('executed');


            if(value.length<12){

                document.getElementById("sendbtn_electricity_all"+id).disabled = true;
                ...
                document.getElementById("sendbtn_electricity_all"+id).disabled = false;
            }

        }


        function minControlCarAll(value,id){



            if(value.length<12){

                document.getElementById("sendbtn_car_all"+id).disabled = true;
                ...
                document.getElementById("sendbtn_car_all"+id).disabled = false;
            }
        ...
        function minControlResearchAll(value,id){



            if(value.length<12){

                document.getElementById("sendbtn_research_all"+id).disabled = true;
                document.getElementById("error_gepg_research_all"+id).style.color = 'red';
                document.getElementById("error_gepg_research_all"+id).style.float = 'left';
                document.getElementById("error_gepg_research_all"+id).style.paddingTop = '1%';
                document.getElementById("error_gepg_research_all"+id).innerHTML ='GePG Control number cannot be less than 12 digits';

            }else{
                document.getElementById("error_gepg_research_all"+id).innerHTML ='';
                document.getElementById("sendbtn_research_all"+id).disabled = false;
            }
    ...
    <script type="text/javascript">
        function openInnerInvoicesInsurance(evt, evtName) {
            // Declare all variables
            var i, tabcontent, tablinks;
    ...
    <script type="text/javascript">
        function openDeepInner(evt, evtName) {
            // Declare all variables
            var i, tabcontent, tablinks;

            // Get all elements with class="tabcontent" and hide them
            tabcontent = document.getElementsByClassName("tabcontent_deep_inner");
            for (i = 0; i < tabcontent.length; i++) {
                tabcontent[i].style.display = "none";
            }

            // Get all elements with class="tablinks" and remove the class "active"
            tablinks = document.getElementsByClassName("tablinks_deep_inner");
        ...
        document.getElementById("defaultOpenDeepInner").click();
    </script>



    <script type="text/javascript">
        function openDeepInnerWater(evt, evtName) {
            // Declare all variables
            var i, tabcontent, tablinks;

            // Get all elements with class="tabcontent" and hide them
            tabcontent = document.getElementsByClassName("tabcontent_deep_inner_water");
            for (i = 0; i < tabcontent.length; i++) {
                tabcontent[i].style.display = "none";
            }

            // Get all elements with class="tablinks" and remove the class "active"
            tablinks = document.getElementsByClassName("tablinks_deep_inner_water");
        ...
        document.getElementById("defaultOpenDeepInnerWater").click();
    </script>

    <script type="text/javascript">
        function openDeepInnerElectricity(evt, evtName) {
            // Declare all variables
            var i, tabcontent, tablinks;

            // Get all elements with class="tabcontent" and hide them
            tabcontent = document.getElementsByClassName("tabcontent_deep_inner_electricity");
            for (i = 0; i < tabcontent.length; i++) {
                tabcontent[i].style.display = "none";
            }

            // Get all elements with class="tablinks" and remove the class "active"
            tablinks = document.getElementsByClassName("tablinks_deep_inner_electricity");
        ...
        document.getElementById("defaultOpenDeepInnerElectricity").click();
    </script>



    <script type="text/javascript">
        function openDeepInnerCar(evt, evtName) {
            // Declare all variables
            var i, tabcontent, tablinks;

            // Get all elements with class="tabcontent" and hide them
            tabcontent = document.getElementsByClassName("tabcontent_inner_car");
            for (i = 0; i < tabcontent.length; i++) {
                tabcontent[i].style.display = "none";
            }

            // Get all elements with class="tablinks" and remove the class "active"
            tablinks = document.getElementsByClassName("tablinks_inner_car");
        ...
        document.getElementById("defaultOpenInnerCar").click();
    </script>



    <script type="text/javascript">
        function openDeepInnerResearch(evt, evtName) {
            // Declare all variables
            var i, tabcontent, tablinks;

            // Get all elements with class="tabcontent" and hide them
            tabcontent = document.getElementsByClassName("tabcontent_inner_research");
            for (i = 0; i < tabcontent.length; i++) {
                tabcontent[i].style.display = "none";
            }

            // Get all elements with class="tablinks" and remove the class "active"
            tablinks = document.getElementsByClassName("tablinks_inner_research");
        ...
        document.getElementById("defaultOpenInnerResearch").click();
    </script>
     ...
     <script type="text/javascript">
        function openDeepInnerinsurance_clients(evt, evtName) {
            // Declare all variables
            var i, tabcontent, tablinks;

            // Get all elements with class="tabcontent" and hide them
            tabcontent = document.getElementsByClassName("tabcontent_inner_insurance_clients");
            for (i = 0; i < tabcontent.length; i++) {
                tabcontent[i].style.display = "none";
            }

            // Get all elements with class="tablinks" and remove the class "active"
            tablinks = document.getElementsByClassName("tablinks_inner_insurance_clients");
        ...
        document.getElementById("defaultOpenInnerinsurance_clients").click();
    </script>



     <script type="text/javascript">
        function openDeepInnerinsurance(evt, evtName) {
            // Declare all variables
            var i, tabcontent, tablinks;

            // Get all elements with class="tabcontent" and hide them
            tabcontent = document.getElementsByClassName("tabcontent_deep_inner_insurance");
            for (i = 0; i < tabcontent.length; i++) {
                tabcontent[i].style.display = "none";
            }

            // Get all elements with class="tablinks" and remove the class "active"
            tablinks = document.getElementsByClassName("tablinks_deep_inner_insurance");
        ...
        document.getElementById("defaultOpenDeepInnerinsurance").click();
    </script>
    ...
    "<'top'<'pull-left 'p>>",
        ...
        var table = $('#myTableResearch').DataTable( {
             dom:
    "<'top'<'pt-3 pull-left'B><'text-center pull-right'f>>"+
    "<'top'<tr>>" +
    "<'top'<'pull-left 'p>>",
            ...
            buttons: [
                {   extend: 'pdfHtml5',
                    filename:'Research Flats Invoices',
                    download: 'open',
                    text: '<i class="fa fa-file-pdf-o"></i> PDF',
                    className: 'excelButton',
                    orientation: 'Landscape',
                    title: 'UNIVERSITY OF DAR ES SALAAM',
                    messageTop: 'DIRECTORATE OF PLANNING, DEVELOPMENT AND INVESTIMENT\n \n Research Flats Invoices',
                    pageSize: 'A4',
                    //layout: 'lightHorizontalLines',
                    exportOptions: {
                        columns: [ 0, 1, 2, 3, 4, 5, 6, 7]
    ...
    "<'top'<'pull-left 'p>>",
            ...
            buttons: [
                {   extend: 'pdfHtml5',
                    filename:'Insurance Invoices Principals',
                    download: 'open',
                    text: '<i class="fa fa-file-pdf-o"></i> PDF',
                    className: 'excelButton',
                    orientation: 'Landscape',
                ...
                {   extend: 'excelHtml5',
                    text: '<i class="fa fa-file-excel-o"></i> EXCEL',
                    className: 'excelButton',
                    title: 'Insurance Invoices Principals',
                    exportOptions: {
                        columns: [1, 2, 3, 4, 5, 6, 7]
                    },
                },
        ...
        var table = $('#myTableInsuranceClients').DataTable( {
             dom:
    "<'top'<'pt-3 pull-left'B><'text-center pull-right'f>>"+
    "<'top'<tr>>" +
    "<'top'<'pull-left 'p>>",
            ...
            buttons: [
                {   extend: 'pdfHtml5',
                    filename:'Insurance Invoices Clients',
                    download: 'open',
                    text: '<i class="fa fa-file-pdf-o"></i> PDF',
                    className: 'excelButton',
                    orientation: 'Landscape',
                ...
                {   extend: 'excelHtml5',
                    text: '<i class="fa fa-file-excel-o"></i> EXCEL',
                    className: 'excelButton',
                    title: 'Insurance Invoices Clients',
                    exportOptions: {
                        columns: [1, 2, 3, 4, 5, 6, 7]
                    },
                },
    ...
    <script>
        ...
        $('#principal').on('input', function(e) {
            ...
            if(query != '')
            {
                ...
                $.ajax({
                    ...
                    success:function(data){
                        if(data=='0'){
                            ...
                            $('#invoice_number_insuranceDiv').show();
                            $('#debtor_account_code_insurance2Div').show();
                            $('#tin_insurance2Div').show();
                            $('#debtor_address_insurance2Div').show();
                ...
                $('#invoice_number_insuranceDiv').hide();
                $('#debtor_account_code_insurance2Div').hide();
                $('#tin_insurance2Div').hide();
                $('#debtor_address_insurance2Div').hide();

                $('#tin_insuranceDiv').hide();
                $('#vrn_insuranceDiv').hide();
                $('#debtor_address_insuranceDiv').hide();
                $('#inc_code_insurance2Div').hide();
                ...
                $.ajax({
                    ...
                    success:function(data){
                        if(data=='x'){
                            ...
                            $('#invoice_number_electricitybillDiv').hide();
                            $('#tin_electricityDiv').hide();
                            $('#vrn_electricityDiv').hide();
                            $('#debtor_address_electricityDiv').hide();
                            $('#inc_code_electricityDiv').hide();
                            $('#inc_code_electricity2Div').hide();
                            $('#inc_code_electricity3Div').hide();
                            $('#inc_code_electricity4Div').hide();
                            ...
                            $('#invoice_number_electricitybillDiv').show();
                            $('#tin_electricityDiv').show();
                            $('#vrn_electricityDiv').show();
                            $('#debtor_address_electricityDiv').show();
                            $('#inc_code_electricityDiv').show();
                            $('#inc_code_electricity2Div').show();
                            $('#inc_code_electricity3Div').show();
                            $('#inc_code_electricity4Div').show();
                ...
                $.ajax({
                    ...
                    success:function(data){
                        if(data=='x'){
                            ...
                            $('#invoice_number_waterbillDiv').hide();
                            $('#debtor_account_code_waterDiv').hide();
                            $('#tin_waterDiv').hide();
                            $('#vrn_waterDiv').hide();
                            $('#debtor_address_waterDiv').hide();
                            $('#inc_code_waterDiv').hide();
                            $('#inc_code_water2Div').hide();
                            $('#inc_code_water3Div').hide();
                            $('#inc_code_water4Div').hide();
                            ...
                            $('#invoice_number_waterbillDiv').show();
                            $('#debtor_account_code_waterDiv').show();
                            $('#tin_waterDiv').show();
                            $('#vrn_waterDiv').show();
                            $('#debtor_address_waterDiv').show();
                            $('#inc_code_waterDiv').show();
                            $('#inc_code_water2Div').show();
                            $('#inc_code_water3Div').show();
                            $('#inc_code_water4Div').show();
    ...
    "<'top'<'pull-left 'p>>",
        ...
        $("#insurance_filter_clients").click(function(e){
            e.preventDefault();
            ...
            if(query!='' && query2!=''){
                ...
                $.ajax({
                    ...
                    .done(function(fragment) {
                        $("#insurance_content_clients").html(fragment);
                        var table = $('#myTableInsuranceClients').DataTable( {
                             dom:
    "<'top'<'pt-3 pull-left'B><'text-center pull-right'f>>"+
    "<'top'<tr>>" +
    ...
    "<'top'<'pull-left 'p>>",
        ...
        $("#research_filter").click(function(e){
            e.preventDefault();
            ...
            if(query!='' && query2!=''){
                ...
                $.ajax({
                    url: "/invoice_management/space/filter?",
                    context: document.body,
                    data:{start:query, end:query2, _token:_token, criteria:'research'}
                })
                    .done(function(fragment) {
                        $("#research_content").html(fragment);
                        var table = $('#myTableResearch').DataTable( {
                             dom:
    "<'top'<'pt-3 pull-left'B><'text-center pull-right'f>>"+
    "<'top'<tr>>" +
...
<script>
        ...
        function minCharacters(value){
            ...
            if(value.length<9){
                ...
                document.getElementById("submit_insurance_principals").disabled = true;
                ...
                document.getElementById("submit_insurance_principals").disabled = false;
            }

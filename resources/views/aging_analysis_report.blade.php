...
<div class="main_content">
  ...
  <div class="container" style="max-width: 100%;">
    <center><h4>
     ...
     <br><br>
            ...
            <span>Aging Analysis Report </span>

            @if($_GET['business_type']!='')
            <span> for <b>{{$_GET['business_type']}}</b> Services</span>
            @else
            @endif

            @if($_GET['location']!='')
                <span> at <b>{{$_GET['location']}}</b> </span>
            @else
            @endif
  ...
  <table class="hover table table-striped  table-bordered" id="myTable">
                            ...
                            <tr>
                                ...
                                <th scope="col" style="width: 16%;"><center>Customer Name</center></th>
                                <th scope="col"><center>Less 3 Months</center></th>
                                <th scope="col" ><center>3 to 6 Months</center></th>
                                <th scope="col" ><center>6 to 12 Months</center></th>

                                <th scope="col"><center>12 to 24 Months</center></th>
                                <th scope="col" ><center>Over 2 Years</center></th>
                                <th scope="col" ><center>Total</center></th>
                            </tr>
                            </thead>
                            <tbody>
                            @foreach($age_analysis as $var)
                                <tr>
                                    ...
                                    <td><center>
                                        <?php
                                            ...
                                            $invoice_date= Carbon::createFromFormat('Y-m-d', $var->invoice_date);
                                            $days_difference = $invoice_date->diffInDays($today_date);
                                            $amount_1=0;

                                            if($days_difference<91){
                                                $amount_1=$var->amount_not_paid;
                                                echo $amount_1.' '.$var->currency_payments;
                                            }else{
                                    ...
                                    <td><center>
                                        <?php
                                            ...
                                            if(91<=$days_difference AND $days_difference<=183){
                                                $amount_2=$var->amount_not_paid;
                                                echo $amount_2.' '.$var->currency_payments;
                                            }else{
                                    ...
                                    <td><center>
                                        <?php
                                            ...
                                            if(183<=$days_difference AND $days_difference<=365){
                                                $amount_3=$var->amount_not_paid;
                                                echo $amount_3.' '.$var->currency_payments;
                                            }else{
                                    ...
                                    <td><center>
                                        <?php
                                            ...
                                            if(365<=$days_difference AND $days_difference<=730){
                                                $amount_4=$var->amount_not_paid;
                                                echo $amount_4.' '.$var->currency_payments;
                                            }else{
                                    ...
                                    <td><center>
                                        <?php
                                            ...
                                            if($days_difference>730){
                                                $amount_5=$var->amount_not_paid;
                                                echo $amount_5.' '.$var->currency_payments;
                                            }else{
                                    ...
                                    <td><center>
                                            ...
                                            echo $total.' '.$var->currency_payments;
...
<script>
    ...
    <?php
     ...
     $title='Aging Analysis Report';
            ...
            $title.='for'.$_GET['business_type'].'Services';
            }
    ...
    var table = $('#myTable').DataTable( {
        ...
        buttons: [
            {   extend: 'pdfHtml5',
                filename:'Aging Analysis Report'+criteria,
                download: 'open',
                ...
                customize: function ( doc ) {
                    ...
                    doc.content[2].table.widths=[22, '*', 70, 70, 70, 70, 70, 80];

...
<div class="container" style="max-width: 100%;">
   ...
   @if ($message = Session::get('errors'))
    ...
    <div id="flats" class="tabcontent" style="padding-top: 10px;">
        <div class="tab2">
            <button class="flatslinks" onclick="openflats(event, 'flats_current')" id="defaultOpenflats"><strong>Active</strong></button>
            <button class="flatslinks" onclick="openflats(event, 'flats_previous')"><strong>Inactive</strong></button>
        </div>

         <div id="flats_current" class="flatscontent">
          <br>
...
@endif
   ...
   <div id="flats_previous" class="flatscontent">
          <br>
            @if($privileges=='Read only')
            @else
              <a class="btn btn-success btn-sm" style="
...
{{--            <hr>--}}
            ...
            @if(count($flats_previous)!=0)
 <table class="hover table table-striped table-bordered" id="myTable_flatsp">
  <thead class="thead-dark">
    <tr>
  <th scope="col" style="color:#fff; width: 5%;"><center>S/N</center></th>
  <th scope="col" style="color:#fff;"><center>Client Name</center></th>
  ...
  <tbody>
    @foreach($flats_previous as $client)
    <tr>
...
{{--<hr>--}}
<?php $a4=1;?>
@if(count($inactive_carclients)!=0)
...
{{-- <hr>--}}
 <?php $a6=1;?>
 @if(count($inactive_insuranceclients)!=0)
...
<script type="text/javascript">
   $(window).on('load', function () {
    ...
    window.onload=function(){
            ...
            $(".flats_clients").removeClass("defaultContract");
            ...
            else if (category=='Research Flats only' || category=='All') {
                $(".space_clients").removeClass("defaultContract");
            $(".car_clients").removeClass("defaultContract");
            $('.flats_clients').addClass('defaultContract');
            }
            else{
...
<script type="text/javascript">
  ...
  function openflats(evt, evtName) {
  // Declare all variables
  var i, tabcontent, tablinks;

  // Get all elements with class="tabcontent" and hide them
  tabcontent = document.getElementsByClassName("flatscontent");
  for (i = 0; i < tabcontent.length; i++) {
    tabcontent[i].style.display = "none";
  }

  // Get all elements with class="tablinks" and remove the class "active"
  tablinks = document.getElementsByClassName("flatslinks");
  for (i = 0; i < tablinks.length; i++) {
    tablinks[i].className = tablinks[i].className.replace(" active", "");
  }
...
document.getElementById("defaultOpenflats").click();
</script>

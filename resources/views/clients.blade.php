...
{{--        <div id="coverScreen"  class="pageLoad"></div>--}}
                    ...
                    @if($category=='Research Flats only')
                        ...
                        <div class="tab">
                            ...
                            @if($category=='Research Flats only' OR $category=='All')
                                <button class="tablinks active flats_clients" onclick='javascript:window.location.href="/clients/research"'><strong>Research Flats</strong></button>
                            @else
                            @endif
                        ...
                        <div id="flats"  style="border-bottom-left-radius: 50px 20px;   border: 1px solid #ccc; padding: 1%;">


                            @if($privileges=='Read only')
                            @else
                                <a class="btn btn-success btn-sm" style="background-color: #38c172; font-size: 14px; padding: 7px; color:white; margin-left: -2px;  margin-bottom: 5px; margin-top: 4px;" href="/contracts_management/research_flats">Add Client</a>
    ...
    float: right;"><i class="fa fa-envelope" aria-hidden="true" style="font-size:20px; color: #f8fafc; cursor: pointer;"></i> Mail</a>
                    ...
                    @elseif($category=='Insurance only')
                        ...
                        <div id="insurance" style="border-bottom-left-radius: 50px 20px;   border: 1px solid #ccc; padding: 1%;" class="" style="padding-top: 10px;">
                            {{-- @if(Auth::user()->role=='Insurance Officer' OR (Auth::user()->role=='System Administrator' OR Auth::user()->role=='Super Administrator')) --}}
                            @if($privileges=='Read only')
                            @else
                                <a class="btn btn-success btn-sm" style="background-color: #38c172; font-size: 14px; padding: 7px; color:white; margin-left: -2px;  margin-bottom: 5px; margin-top: 4px;" href="/insurance_contract_form">Add Client</a>
    ...
    float: right;"><i class="fa fa-envelope" aria-hidden="true" style="font-size:20px; color: #f8fafc; cursor: pointer;"></i> Mail</a>
          ...
          <td><center>{{date("d/m/Y",strtotime($client->commission_date))}} - {{date("d/m/Y",strtotime($client->end_date))}}</center></td> --}}
                        ...
                        <div class="tab">
                            ...
                            @if ($category=='CPTU only' OR $category=='All')
                                <button class="tablinks active car_clients" onclick='javascript:window.location.href="/clients/car_rental"'><strong>Car Rental</strong></button>
                            @else
                            @endif
                        ...
                        <div id="car" style="border-bottom-left-radius: 50px 20px;   border: 1px solid #ccc; padding: 1%;"  style="padding-top: 10px;">
    ...
    float: right;"><i class="fa fa-envelope" aria-hidden="true" style="font-size:20px; color: #f8fafc; cursor: pointer;"></i> Mail</a>
                ...
                <div id="space" style="border-bottom-left-radius: 50px 20px;   border: 1px solid #ccc; padding: 1%;" class="" style="padding-top: 10px;">

                    {{--  @if(Auth::user()->role=='DPDI Planner' OR (Auth::user()->role=='System Administrator' OR Auth::user()->role=='Super Administrator')) --}}

                    @if($privileges=='Read only')
                    @else
                        <a class="btn btn-success btn-sm" style="background-color: #38c172; font-size: 14px; padding: 7px; color:white; margin-left: -2px;  margin-bottom: 5px; margin-top: 4px;" href="/space_contract_form">Add Client</a>
...
@section('pagescript')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            var table22 = $('#myTable_flatsc').DataTable( {
                dom:
                ...
                buttons: [
                    {   extend: 'pdfHtml5',
                        ...
                        customize: function ( doc ) {
                            ...
                            doc.content[2].table.widths=[22, '*', 80,80, 120, 80];
                    ...
                    {   extend: 'excelHtml5',
                        ...
                        className: 'excelButton',
                        title: 'Research Flats Active Clients',
                        exportOptions: {
                            columns: [1, 2, 3, 4,5]
                        },
                    },
            ...
            var table23 = $('#myTable_flatsp').DataTable( {
                ...
                buttons: [
                    {   extend: 'pdfHtml5',
                        filename:'Research Flats Inactive Clients',
                        download: 'open',
                        text: '<i class="fa fa-file-pdf-o"></i> PDF',
                        className: 'excelButton',
                        orientation: 'Potrait',
                        title: 'UNIVERSITY OF DAR ES SALAAM',
                        messageTop: 'DIRECTORATE OF PLANNING, DEVELOPMENT AND INVESTIMENT\n \n Research Flats Inactive Clients',
                        pageSize: 'A4',
                        //layout: 'lightHorizontalLines',
                        exportOptions: {
                            columns: [ 0, 1, 2, 3, 4,5]
                    ...
                    {   extend: 'excelHtml5',
                        text: '<i class="fa fa-file-excel-o"></i> EXCEL',
                        className: 'excelButton',
                        title: 'Research Flats Inactive Clients',
                        exportOptions: {
                            columns: [1, 2, 3, 4,5]
                        },
                    },
                ...
                buttons: [
                    {   extend: 'pdfHtml5',
                        ...
                        customize: function ( doc ) {
                            ...
                            doc.content[2].table.widths=[22, '*', 80, 120, 80];
                            var rowCount = doc.content[2].table.body.length;
                            for (i = 1; i < rowCount; i++) {
                                doc.content[2].table.body[i][0]=i+'.';
                                doc.content[2].table.body[i][1].alignment = 'left';
                    ...
                    {   extend: 'excelHtml5',
                        text: '<i class="fa fa-file-excel-o"></i> EXCEL',
                        className: 'excelButton',
                        title: 'Real Estate Active Clients',
                        exportOptions: {
                            columns: [1, 2, 3, 4]
                        },
                    },
            ...
            var table = $('#myTable1').DataTable( {
                ...
                buttons: [
                    {   extend: 'pdfHtml5',
                        filename:'Real Estate Inactive Clients',
                        download: 'open',
                        text: '<i class="fa fa-file-pdf-o"></i> PDF',
                        className: 'excelButton',
                        orientation: 'Potrait',
                        title: 'UNIVERSITY OF DAR ES SALAAM',
                        messageTop: 'DIRECTORATE OF PLANNING, DEVELOPMENT AND INVESTIMENT\n \n Real Estate Inactive Clients',
                        pageSize: 'A4',
                        //layout: 'lightHorizontalLines',
                        exportOptions: {
                            columns: [ 0, 1, 2, 3, 4, 5]
                        ...
                        customize: function ( doc ) {
                            ...
                            doc.content[2].table.widths=[22, '*', 70, 110, 70,60];
                            var rowCount = doc.content[2].table.body.length;
                            for (i = 1; i < rowCount; i++) {
                                doc.content[2].table.body[i][0]=i+'.';
                                doc.content[2].table.body[i][1].alignment = 'left';
                    ...
                    {   extend: 'excelHtml5',
                        text: '<i class="fa fa-file-excel-o"></i> EXCEL',
                        className: 'excelButton',
                        title: 'Real Estate Inactive Clients',
                        exportOptions: {
                            columns: [1, 2, 3, 4, 5]
                        },
                    },
                ...
                buttons: [
                    {   extend: 'pdfHtml5',
                        ...
                        customize: function ( doc ) {
                            ...
                            doc.content[2].table.widths=[22, 110, 60, '*', 110];
                            var rowCount = doc.content[2].table.body.length;
                            for (i = 1; i < rowCount; i++) {
                                doc.content[2].table.body[i][0]=i+'.';
                                doc.content[2].table.body[i][1].alignment = 'left';

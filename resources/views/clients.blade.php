...
@section('content')
    ...
    <div class="wrapper">
        ...
        <div class="main_content">
            ...
            <div class="container" style="max-width: 100%;">
                ...
                <div id="flats" class="tabcontent" style="border-bottom-left-radius: 50px 20px;   border: 1px solid #ccc; padding: 1%;">
    ...
    float: right;"><i class="fa fa-envelope" aria-hidden="true" style="font-size:20px; color: #f8fafc; cursor: pointer;"></i> Mail</a>
                ...
                <div id="space" style="border-bottom-left-radius: 50px 20px;   border: 1px solid #ccc; padding: 1%;" class="tabcontent" style="padding-top: 10px;">
    ...
    float: right;"><i class="fa fa-envelope" aria-hidden="true" style="font-size:20px; color: #f8fafc; cursor: pointer;"></i> Mail</a>
                ...
                <div id="car" style="border-bottom-left-radius: 50px 20px;   border: 1px solid #ccc; padding: 1%;" class="tabcontent" style="padding-top: 10px;">
    ...
    float: right;"><i class="fa fa-envelope" aria-hidden="true" style="font-size:20px; color: #f8fafc; cursor: pointer;"></i> Mail</a>
                ...
                <div id="insurance" style="border-bottom-left-radius: 50px 20px;   border: 1px solid #ccc; padding: 1%;" class="tabcontent" style="padding-top: 10px;">

                                                ...
                                                <div class="form-card">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div id="insurance_companyDiv" class="form-wrapper col-12"  >
                                                                <br>
                                                            ...
                                                            <div id="client_nameDiv" class="form-wrapper col-12" style="display: none;">
                                                                ...
                                                                <input type="text" id="full_name" name="full_name" value="{{$var->full_name}}" readonly class="form-control" autocomplete="off">
                                                            ...
                                                            <div id="emailDiv" class="form-wrapper col-6 pt-4" style="display: none;">
                                                                ...
                                                                <input type="text" name="email" readonly value="{{$var->email}}" id="email" class="form-control" placeholder="someone@example.com" pattern="^([a-zA-Z0-9_\-\.]+)@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.)|(([a-zA-Z0-9\-]+\.)+))([a-zA-Z]{2,4}|[0-9]{1,3})(\]?)$" maxlength="50">
                                                            </div>

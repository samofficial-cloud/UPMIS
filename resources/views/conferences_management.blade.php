...
<br>
        <p class="mt-1" style="font-size:28px !important; ">Conference Centre Events Management</p>
...
<br>
 <a style="cursor: pointer; color: black; font-weight: bold; background-color: #38c172; color:white; background-clip: border-box; border: 1px solid rgba(0, 0, 0, 0.125); padding: 1%; border-radius: 0.25rem;" data-toggle="modal" title="Add new event" data-target="#add_event"  role="button" aria-pressed="true" name="editC">Add New Event </a>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <b><h5 class="modal-title">Adding New Event</h5></b>

                  <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>

                <div class="modal-body">
                  <form method="post" action="{{ route('add_event')}}"  id="form1" >
                    {{csrf_field()}}


                      <div class="form-group">
                          <div class="form-wrapper">
                              <label for=""  ><strong>Client Name<span style="color: red;"> *</span> </strong></label>
                              <input type="text" class="form-control"   name="client_name" value="" required autocomplete="off">
                      ...
                      <div  class="form-group">
                          <div class="form-wrapper">
                              <label for=""><strong>Conference ID<span style="color: red;"> *</span></strong></label>


                              <select id="" class="form-control" name="conference_id" required>

                                  <option value="" selected></option>

                                  <?php

                                  $conference_ids=DB::table('spaces')->select('space_id')->where('minor_industry','Conference centre')->get();

                                  $tempOut = array();
                                  foreach($conference_ids as $values){
                                      $iterator = new RecursiveIteratorIterator(new RecursiveArrayIterator($values));
                                      $val = (iterator_to_array($iterator,true));
                                      $tempoIn=$val['space_id'];

                                      if(!in_array($tempoIn, $tempOut))
                                      {
                                          print('<option value="'.$val['space_id'].'">'.$val['space_id'].'</option>');
                      ...
                      <div class="form-group">
                          <div class="form-wrapper">
                              <label for=""  ><strong>Event Description<span style="color: red;"> *</span> </strong></label>
                              <input type="text" class="form-control"   name="event_description" value="" required autocomplete="off">
                      ...
                      <div class="form-group">
                          <div class="form-wrapper">
                              <label for=""  ><strong>Rent<span style="color: red;"> *</span> </strong></label>
                              <input type="number" class="form-control"   name="rent" value="" required autocomplete="off">
                      ...
                      <div  class="form-group">
                          <div class="form-wrapper">
                              <label for=""><strong>Currency<span style="color: red;"> *</span></strong></label>

                              <select id="" class="form-control" name="rent_currency" required>
                                  <option value="" ></option>
        ...
        <div style="margin-top: 2%;">
            ...
            <table class="hover table table-striped table-bordered" id="myTable">
              ...
              <tr>
                ...
                <th scope="col" style="color:#fff;">Event Description</th>
                <th scope="col" style="color:#fff;">Conference ID</th>
                <th scope="col" style="color:#fff;">Rent</th>
                <th scope="col" style="color:#fff;">Event Date</th>
              ...
              @foreach($events as $var)
                <tr>
                  ...
                  <td>{{$var->event_description}}</td>
                  <td>{{$var->conference_id}}</td>
                  <td>{{$var->rent}} {{$var->rent_currency}}</td>
                  <td>{{date('d/m/Y',strtotime($var->event_date))}}</td>
                  <td><center>


                    <a style="cursor: pointer;" data-toggle="modal" title="Edit event information" data-target="#edit_event{{$var->id}}"  role="button" aria-pressed="true" name="editC"><i class="fa fa-edit" style="font-size:25px; color: green;"></i></a>

                    <a style="cursor: pointer;" data-toggle="modal" title="Delete event" data-target="#delete_event{{$var->id}}" role="button" aria-pressed="true"><i class="fa fa-trash" aria-hidden="true" style="font-size:25px; color:red;"></i></a>




                      <div class="modal fade" id="edit_event{{$var->id}}" role="dialog">

                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            <b><h5 class="modal-title">Editing {{$var->client_name}}'s event            </h5></b>

                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                          </div>

                          <div class="modal-body">
                            <form method="post" action="{{ route('edit_event',$var->id)}}"  id="form1" >
                              {{csrf_field()}}
                                ...
                                <div class="form-group">
                                    <div class="form-wrapper">
                                        <label for=""  ><strong>Client Name<span style="color: red;"> *</span> </strong></label>
                                        <input type="text" class="form-control"   name="client_name" value="{{$var->client_name}}" required autocomplete="off">
                                ...
                                <div  class="form-group">
                                    <div class="form-wrapper">
                                        ...
                                        <select id="" class="form-control" name="conference_id" required>
                                            ...
                                            <option value="{{$var->conference_id}}" selected>{{$var->conference_id}}</option>

                                            <?php
                                            $conference_ids=DB::table('spaces')->select('space_id')->where('minor_industry','Conference')->get();

                                            ?>

                                            @foreach($conference_ids as $conference_id)

                                              @if($conference_id->space_id!=$var->conference_id)
                                                    <option value="{{$conference_id->space_id}}" selected>{{$conference_id->space_id}}</option>
                                ...
                                <div class="form-group">
                                    <div class="form-wrapper">
                                        <label for=""  ><strong>Event Description<span style="color: red;"> *</span> </strong></label>
                                        <input type="text" class="form-control"   name="event_description" value="{{$var->event_description}}" required autocomplete="off">
                                ...
                                <div class="form-group">
                                    <div class="form-wrapper">
                                        <label for=""  ><strong>Rent<span style="color: red;"> *</span> </strong></label>
                                        <input type="number" class="form-control"   name="rent" value="{{$var->rent}}" required autocomplete="off">
                                ...
                                <div  class="form-group">
                                    <div class="form-wrapper">
                                        ...
                                        <select id="" class="form-control" name="rent_currency" required>
                                            <option value="{{$var->rent_currency}}" selected>{{$var->rent_currency}}</option>
                                            @if($var->rent_currency=='TZS')
                                                <option value="USD" >USD</option>
                                            @elseif($var->rent_currency=='USD')
                                                <option value="TZS" >TZS</option>
                                            @else
                                            @endif
                                        </select>
                    ...
                    <div class="modal fade" id="delete_event{{$var->id}}" role="dialog">
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form method="post" action="{{ route('delete_event',$var->id)}}" >
                              {{csrf_field()}}
        ...
        buttons: [
            {   extend: 'pdfHtml5',
                ...
                customize: function ( doc ) {
                  ...
                  doc.content[2].table.widths=[22,70, '*', 60,60,60];
        ...
        fillColor: function (rowIndex, node, columnIndex) {
          return (rowIndex % 2 === 0) ? '#ffffff' : '#ffffff';
            ...
            {   extend: 'excelHtml5',
                ...
                className: 'excelButton',
                title: 'Conference Centre Events Management',
                exportOptions: {
                columns: [1, 2,3,4,5]
                },
            },

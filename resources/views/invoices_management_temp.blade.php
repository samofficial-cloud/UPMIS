...
@if(Auth::user()->role=='Accountant-DPDI' || Auth::user()->role=='DPDI Planner')
                        ...
                        <div class="tab" style="">
                            ...
                            <button class="tablinks_deep_inner " onclick="openDeepInner(event, 'space_invoice_inbox')" id="defaultOpenDeepInner"><strong>Inbox</strong></button>
                            <button class="tablinks_deep_inner " onclick="openDeepInner(event, 'space_invoice_outbox')"><strong>Outbox</strong></button>
                            <button class="tablinks_deep_inner " onclick="openDeepInner(event, 'space_complete_invoices')"><strong>Invoices</strong></button>
                        </div>
                                    ...
                                    @if($space_invoice_inbox!='')
                                        ...
                                        <div  id="">
                                            ...
                                            <table class="table">
                                                ...
                                                @foreach($space_invoice_inbox as $var)
                                                    <tr>
                                                            ...
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <form method="post" action="{{ route('foward_space_invoice',$var->invoice_number)}}"  id="form1" >
                                                                            {{csrf_field()}}
                                                                            ...
                                                                            <div align="right">
                                                                                <button id="submit_space" class="btn btn-primary" type="submit">Foward</button>
                                                                                <button class="btn btn-danger" type="button" class="close" data-dismiss="modal">Cancel</button>
                                                                            </div>
                                                                        </form>
                            ...
                            @if($space_invoice_outbox!='')
                                ...
                                <div>
                                    ...
                                    <table class=" table ">
                                        ...
                                        @foreach($space_invoice_outbox as $var)
                                            <tr>
                                            ...
                                            @foreach($space_invoice_outbox as $var)
                                                <tr>
                                                    ...
                                                    <td><center>
                                                            ...
                                                            <a  title="View invoice" style="color:#3490dc !important; display:inline-block;"  class="" data-toggle="modal" data-target="#invoice_outbox{{$var->invoice_number}}" style="cursor: pointer;" aria-pressed="true"><center><i class="fa fa-eye" aria-hidden="true"></i></center></a>
                                                            <div class="modal fade" id="invoice_outbox{{$var->invoice_number}}" role="dialog">
                                                            ...
                                                            <a title="View contract" style="color:#3490dc !important; display:inline-block;"  class="" data-toggle="modal" data-target="#contract_outbox{{$var->invoice_number}}" style="cursor: pointer;" aria-pressed="true"><center><i class="fa fa-file-text" aria-hidden="true"></i></center></a>
                                                            <div class="modal fade" id="contract_outbox{{$var->invoice_number}}" role="dialog">
                                                            ...
                                                            @if($var->email_sent_status=='NOT SENT')
                                                                ...
                                                                @else
                                                                    ...
                                                                    @if($var->gepg_control_no=='')
                                                                        <a title="Add control number" data-toggle="modal" style="color: #3490dc; cursor: pointer;"  data-target="#add_control_number_outbox{{$var->invoice_number}}"  role="button" aria-pressed="true" name="editC"><i class="fas fa-file-medical"></i></a>
                                                                    @else
                                                                    @endif
                                                                ...
                                                                <div class="modal fade" id="add_control_number_outbox{{$var->invoice_number}}" role="dialog">
                                                            ...
                                                            @if($var->email_sent_status=='SENT')
                                                                ...
                                                                @else
                                                                    ...
                                                                    @if($var->payment_status=='Not paid' AND Auth::user()->role=='Accountant-DPDI')
                                                                        <a title="Receive payment" data-toggle="modal" data-target="#add_comment_outbox{{$var->invoice_number}}"  role="button" aria-pressed="true"   name="editC"><i class="fa fa-money" style="font-size:20px; color:#3490dc !important;" aria-hidden="true"></i></a>
                                                                    @else
                                                                    @endif

                                                                @endif

                                                                <div class="modal fade" id="add_comment_outbox{{$var->invoice_number}}" role="dialog">
...
{{--                        space invoice outbox end--}}


{{--Complete space invoices start--}}
                        <div id="space_complete_invoices" style="border-bottom-left-radius: 50px 20px;   border: 1px solid #ccc; padding: 1%;" class="tabcontent_deep_inner">
                        <br>
                    ...
                    @else
                        <div id="space_invoices_inner" style="border: 1px solid #ccc; padding: 1%; border-bottom-left-radius: 50px 20px; " class="tabcontent_inner">
                            ...
                            @if(Auth::user()->role=='Accountant-DPDI' || Auth::user()->role=='DPDI Planner')
                                                        ...
                                                        <td><center>
                                                                ...
                                                                <div class="modal fade" id="invoice{{$var->invoice_number}}" role="dialog">
                                                                    ...
                                                                    <div class="modal-dialog" role="document">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <b><h5 class="modal-title">Forwarding invoice to Accountant-DPDI</h5></b>
                                ...
                                {{--Complete space invoices start--}}
                                <div id="space_complete_invoices" class="tabcontent_deep_inner">
                                    <br>
...
<br>
                        ...
                        @else
                            ...
                            <div style="margin-bottom: 3%;"><div style="float:left;"></div><a data-toggle="modal" class="btn button_color active" style="background-color: #38c172; padding: 7px; color:white; margin-left: -2px;  margin-bottom: 5px; margin-top: 4px;"  data-target="#new_invoice_water" title="Add new water bill invoice" role="button" aria-pressed="true">Add New Invoice</a>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form method="post" action="{{ route('create_water_invoice_manually')}}"  id="form1" >
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div id="invoice_number_waterbillDiv" style="display: none;" class="form-group col-md-12">
                                                    <div class="form-wrapper">
                                                        <label for="">Invoice number <span style="color: red;">*</span></label>
                                                        <input type="number" min="1" class="form-control" id="invoice_number_waterbill" name="invoice_number" value=""  required autocomplete="off">

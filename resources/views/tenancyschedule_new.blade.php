   ...
   <center><h4>
    ...
    @endif
        ...
        @if($_GET['client_type_contract']=='Indirect')
            ...
            <?php
            $parent_client_name=DB::table('clients')->where('client_id',$_GET['parent_client'])->value('full_name');

            ?>
            <span>for Clients Under <b>{{$parent_client_name}}</b>  </span>
        @else
        @endif
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>{{$detail->space_id_contract}}</td>
        <?php
        $area_size=DB::table('spaces')->where('space_id',$detail->space_id_contract)->value('size');
        ?>
      ...
      <td><center>{{date("d/m/Y",strtotime($detail->end_date))}}</center></td>
        ...
        <?php
        $rent_sqm=DB::table('space_contracts')->where('contract_id',$detail->contract_id)->value('rent_sqm');
        ?>

      <td style="text-align: center;">{{$rent_sqm}}</td>
...
var base64 = '';
  ...
  function settitle(){
    ...
    if($_GET['client_type_contract']=='Indirect'){
           ...
           if(($_GET['b_fil']=='true') && ($_GET['l_fil']=='true')){
        echo 'Tenancy Schedule '.DateTime::createFromFormat('!m', $x1)->format('F').' '.$_GET['year'].' to '.DateTime::createFromFormat('!m', $x3)->format('F').' '.$_GET['year'].' for '.$_GET['b_type'].' at '.$_GET['loc'].' Area'.' for Clients Under '.$parent_client_name;
      }

    elseif(($_GET['b_fil']=='true') && ($_GET['l_fil']!='true')){
      echo 'Tenancy Schedule '.DateTime::createFromFormat('!m', $x1)->format('F').' '.$_GET['year'].' to '.DateTime::createFromFormat('!m', $x3)->format('F').' '.$_GET['year'].' for '.$_GET['b_type'].' for Clients Under '.$parent_client_name;
    }
    elseif(($_GET['b_fil']!='true') && ($_GET['l_fil']=='true')){
      echo 'Tenancy Schedule '.DateTime::createFromFormat('!m', $x1)->format('F').' '.$_GET['year'].' to '.DateTime::createFromFormat('!m', $x3)->format('F').' '.$_GET['year'].' at '.$_GET['loc'].' Area'.' for Clients Under '.$parent_client_name;
    }
    elseif(($_GET['b_fil']!='true') && ($_GET['l_fil']!='true')){
      echo 'Tenancy Schedule '.DateTime::createFromFormat('!m', $x1)->format('F').' '.$_GET['year'].' to '.DateTime::createFromFormat('!m', $x3)->format('F').' '.$_GET['year'].' for Clients Under '.$parent_client_name;
    }
    ...
    elseif(($_GET['b_fil']!='true') && ($_GET['l_fil']=='true')){
      echo 'Tenancy Schedule '.DateTime::createFromFormat('!m', $x1)->format('F').' '.$_GET['year'].' to '.DateTime::createFromFormat('!m', $x3)->format('F').' '.$_GET['year'].' at '.$_GET['loc'].' Area';
    }
    elseif(($_GET['b_fil']!='true') && ($_GET['l_fil']!='true')){
        ...
        buttons: [
            {   extend: 'pdfHtml5',
                ...
                customize: function ( doc ) {
                  ...
                  doc.content[2].table.widths = [22, 60,55, '*', 70, 70,60, 60, 70, 80];
        ...
        buttons: [
            {   extend: 'pdfHtml5',
                ...
                customize: function ( doc ) {
                  ...
                  doc.content[2].table.widths = [22, 50,60, '*', 60, 60,50, 60, 60, 70, 70];
        ...
        buttons: [
            {   extend: 'pdfHtml5',
                ...
                customize: function ( doc ) {
                  ...
                  doc.content[2].table.widths = [22, 70,60, '*', 50, 50,50, 60, 60, 60, 60, 60];
        ...
        buttons: [
            {   extend: 'pdfHtml5',
                ...
                customize: function ( doc ) {
                  ...
                  doc.content[2].table.widths = [22, 50,53, '*', 48, 48,45 ,35,40, 50, 55, 55, 55, 55];
        ...
        buttons: [
            {   extend: 'pdfHtml5',
                ...
                customize: function ( doc ) {
                  ...
                  doc.content[2].table.widths = [22, 50,55, '*', 48, 48,30, 40, 40, 50, 50, 50, 50, 50];
                  ...
                  var rowCount = doc.content[2].table.body.length;
                      ...
                      doc.content[2].table.body[i][9].alignment = 'right';
                      doc.content[2].table.body[i][10].alignment = 'right';
                      doc.content[2].table.body[i][11].alignment = 'right';
                    };

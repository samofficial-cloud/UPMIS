  ...
  <div class="card-body">
   <form class="form" method="POST" action="/change_password_details">
          ...
          <div class="form-group{{ $errors->has('new-password') ? ' has-error' : '' }} row">
            <label for="new-password" class="col-sm-4 control-label"><strong>New Password: <span style="color: red;">*</span></strong><br><p style="font-size: 11px; color: red; margin-bottom: -1rem;">Password must be at least 8 characters long with at least one upper case letter, one small letter, one digit and one special character</p></label>

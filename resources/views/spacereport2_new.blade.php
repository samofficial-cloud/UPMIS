...
<div class="main_content">
  ...
  <div class="container" style="max-width: 100%;">
   <center><h4>
    ...
    @else
      <br><br>{{$_GET['space_id']}} - {{$location}}, Renting History Report
    @endif
  </h4></center>
    <hr>
<div class="card">
  <div class="card-body">
    ...
    <hr>
<table style="width: 60%;" id="t_id">
  @foreach($details as $details)
  <tr>
    <td style="width: 25%;">Major Industry</td>
    <td>{{$details->major_industry}}</td>
  </tr>
  <tr>
    <td>Location</td>
    <td>{{$details->location}}, {{$details->sub_location}}</td>
  </tr>
  <tr>
    <td>Size in m2</td>
    <td>{{$details->size}}</td>
...
<table class="hover table table-striped  table-bordered" id="myTable3">
                            ...
                            @foreach($invoices as $var)
                                <tr>
                                    ...
                                    <td><center>{{$var->currency}} {{number_format($var->amount_not_paid)}}</center></td>
                                  </tr>
                                  <?php
                                  $i=$i+1;
                                  ?>

            ...
            <div class="container " style="max-width: 100%;">
                ...
                <br>
                    ...
                    <center><h4>
                            ...
                            <span class="mt-1" style="font-size:25px !important; ">Conference Centre Income Report</span>


                            @if($_GET['filter_date']=='true')
                                <span>from {{date('d/m/Y',strtotime($_GET['start_date']))}} to {{date('d/m/Y',strtotime($_GET['end_date']))}}</span>
                            @else
                            @endif
                    ...
                    <table class="table table-bordered" style="width: 60%; background-color: white;" id="t_id">
                        @foreach($location as $location_details)
                            <tr>
                                <td style="width: 25%;">Conference Centre ID</td>
                                <td>{{$_GET['space_id']}}</td>
                            </tr>
                            <tr>
                                <td>Location</td>
                                <td>{{$location_details->location}}, {{$location_details->sub_location}}</td>
                            </tr>
                ...
                <div style="margin-top: 2%;">
                    ...
                    <table class="hover table table-striped table-bordered" id="myTable">
                        ...
                        @foreach($conference_events as $var)
                            <tr>
                        ...
                        foreach ($conference_events as $var){
                            ...
                            if($var->rent_currency=='USD'){

                                $total_amount_usd+=$var->rent;

                            }else{


                                $total_amount_tzs+=$var->rent;
                        ...
                        <tr>
                            ...
                            <td>Total TZS= {{number_format($total_amount_tzs)}}</td>
                        ...
                        <tr>
                            ...
                            <td>Total USD= {{number_format($total_amount_usd)}}</td>
...
@section('pagescript')
    ...
    <script type="text/javascript">
        ...
        function setTitle() {
            return '\n\n <?php
                ...
                if ($_GET['filter_date'] == 'true') {
                    ...
                    echo 'Conference Centre(' . $_GET['space_id'] . ') Income Report from ' . date('d/m/Y', strtotime($_GET['start_date'])) . ' to ' . date('d/m/Y', strtotime($_GET['end_date']));
                } else {


                    echo 'Conference Centre(' . $_GET['space_id'] . ') Income Report';
                }
        ...
        var table = $('#myTable').DataTable( {
            ...
            buttons: [
                {   extend: 'pdfHtml5',
                    filename:'Conference Centre Income Management Report',
                    download: 'open',
                    ...
                    customize: function ( doc ) {
                        ...
                        doc.content[2].table.widths=[22,70, '*', 80,60];

...
<div class="main_content">
  ...
  <?php
    ...
    $i=1;
    $k =1;
    $model = carRental::select('vehicle_model')->where('vehicle_reg_no',$_GET['reg'])->value('vehicle_model');
  ?>
  <div class="container" style="max-width: 100%;">
   <center><h4>
     @if($_GET['date_fil']=='true') 
      <br><br>History Report for {{$_GET['reg']}} - {{$model}} Between {{date("d/m/Y",strtotime($_GET['start']))}} and {{date("d/m/Y",strtotime($_GET['end']))}} 
    @else
     <br><br>History Report for {{$_GET['reg']}} - {{$model}}
    @endif
   </h4></center>
...
var base64 = '';
  function settitle(){
    ...
    $model = carRental::select('vehicle_model')->where('vehicle_reg_no',$_GET['reg'])->value('vehicle_model');
      if($_GET['date_fil']=='true'){
        echo 'Bookings History Report for '.$_GET['reg'].' - '.$model.' Between '.date("d/m/Y",strtotime($_GET['start'])).' and '.date("d/m/Y",strtotime($_GET['end']));
      }
      else{
        echo 'Bookings History Report for '.$_GET['reg'].' - '.$model;
      }
    ?>';
  }
  ...
  function settitle2(){
    ...
    $model = carRental::select('vehicle_model')->where('vehicle_reg_no',$_GET['reg'])->value('vehicle_model');
      if($_GET['date_fil']=='true'){
        echo 'Operational Expenditure History Report for '.$_GET['reg'].' - '.$model.' Between '.date("d/m/Y",strtotime($_GET['start'])).' and '.date("d/m/Y",strtotime($_GET['end']));
      }
      else{
        echo 'Operational Expenditure History Report for '.$_GET['reg'].' - '.$model;
      }
    ?>';
  }
        ...
        buttons: [
            {   extend: 'pdfHtml5',
                ...
                customize: function ( doc ) {
                  ...
                  doc.content[2].table.widths = [22, '*', 100, 100, 100, 140];
        ...
        buttons: [
            {   extend: 'pdfHtml5',
                ...
                customize: function ( doc ) {
                  ...
                  doc.content[2].table.widths = [22, 80, 90, '*',100,80, 80, 80];
                  var rowCount = doc.content[2].table.body.length;
                      for (i = 1; i < rowCount; i++) {
                         doc.content[2].table.body[i][0]=i+'.';
                      doc.content[2].table.body[i][1].alignment = 'left';

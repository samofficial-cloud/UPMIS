    ...
    @if(count($clients)>0)
        <table class="hover table table-striped table-bordered" id="myTable1">
          ...
          <tbody>
            @foreach($clients as $client)
            <tr>
            <td scope="row" style="text-align: center;">{{$a2}}.</td>
...
function settitle(){
  ...
  if($_GET['report_type']=='cars'){
    if(($_GET['model_fil']=='true')&&($_GET['stat_fil']=='true')&&($_GET['range_fil']=='true')&&($_GET['rent_fil']=='true')){
        echo 'List of '.$_GET['rent'].' vehicles between '.date("d/m/Y",strtotime($_GET['start'])).' and '.date("d/m/Y",strtotime($_GET['end'])).' whose model is '.$_GET['model'].', vehicle status is '.$_GET['status'].' and hire rate is between TZS '.number_format($_GET['min']).' and  TZS '.number_format($_GET['max']);
    }
    elseif(($_GET['model_fil']=='true')&&($_GET['stat_fil']=='true')&&($_GET['range_fil']=='true')&&($_GET['rent_fil']!='true')){
          echo 'List of vehicles whose model is '.$_GET['model'].', vehicle status is '.$_GET['status'].' and hire rate is between TZS '.number_format($_GET['min']).' and  TZS '.number_format($_GET['max']);
    }
    elseif(($_GET['model_fil']=='true')&&($_GET['stat_fil']=='true')&&($_GET['range_fil']!='true')&&($_GET['rent_fil']=='true')){
          echo 'List of '.$_GET['rent'].' vehicles between '.date("d/m/Y",strtotime($_GET['start'])).' and '.date("d/m/Y",strtotime($_GET['end'])).' whose model is '.$_GET['model'].' and vehicle status is '.$_GET['status'];
    }
    elseif(($_GET['model_fil']=='true')&&($_GET['stat_fil']=='true')&&($_GET['range_fil']!='true')&&($_GET['rent_fil']!='true')){
          echo 'List of vehicles whose model is '.$_GET['model'].' and vehicle status is '.$_GET['status'];
    }
    elseif(($_GET['model_fil']=='true')&&($_GET['stat_fil']!='true')&&($_GET['range_fil']=='true')&&($_GET['rent_fil']=='true')){
          echo 'List of '.$_GET['rent'].' vehicles between '.date("d/m/Y",strtotime($_GET['start'])).' and '.date("d/m/Y",strtotime($_GET['end'])).' whose model is '.$_GET['model'].' and hire rate is between TZS '.number_format($_GET['min']).' and  TZS '.number_format($_GET['max']);
    }
    elseif(($_GET['model_fil']=='true')&&($_GET['stat_fil']!='true')&&($_GET['range_fil']=='true')&&($_GET['rent_fil']!='true')){
        echo 'List of vehicles whose model is '.$_GET['model'].' and hire rate is between TZS '.number_format($_GET['min']).' and  TZS '.number_format($_GET['max']);
    }
    elseif(($_GET['model_fil']=='true')&&($_GET['stat_fil']!='true')&&($_GET['range_fil']!='true')&&($_GET['rent_fil']=='true')){
        echo 'List of '.$_GET['rent'].' vehicles between '.date("d/m/Y",strtotime($_GET['start'])).' and '.date("d/m/Y",strtotime($_GET['end'])).' whose model is '.$_GET['model'];
    }
    elseif(($_GET['model_fil']=='true')&&($_GET['stat_fil']!='true')&&($_GET['range_fil']!='true')&&($_GET['rent_fil']!='true')){
        echo 'List of vehicles whose model is '.$_GET['model'];
    }
    elseif(($_GET['model_fil']!='true')&&($_GET['stat_fil']=='true')&&($_GET['range_fil']=='true')&&($_GET['rent_fil']=='true')){
        echo 'List of '.$_GET['rent'].' vehicles between '.date("d/m/Y",strtotime($_GET['start'])).' and '.date("d/m/Y",strtotime($_GET['end'])).' whose vehicle status is '.$_GET['status'].' and hire rate is between TZS '.number_format($_GET['min']).' and  TZS '.number_format($_GET['max']);
    }
    elseif(($_GET['model_fil']!='true')&&($_GET['stat_fil']=='true')&&($_GET['range_fil']=='true')&&($_GET['rent_fil']!='true')){
          echo 'List of vehicles whose vehicle status is '.$_GET['status'].' and hire rate is between TZS '.number_format($_GET['min']).' and  TZS '.number_format($_GET['max']);
    }
    elseif(($_GET['model_fil']!='true')&&($_GET['stat_fil']=='true')&&($_GET['range_fil']!='true')&&($_GET['rent_fil']=='true')){
        echo 'List of '.$_GET['rent'].' vehicles between '.date("d/m/Y",strtotime($_GET['start'])).' and '.date("d/m/Y",strtotime($_GET['end'])).' whose vehicle status is '.$_GET['status'];
    }
    elseif(($_GET['model_fil']!='true')&&($_GET['stat_fil']=='true')&&($_GET['range_fil']!='true')&&($_GET['rent_fil']!='true')){
        echo 'List of vehicles whose vehicle status is '.$_GET['status'];
    }
    elseif(($_GET['model_fil']!='true')&&($_GET['stat_fil']!='true')&&($_GET['range_fil']=='true')&&($_GET['rent_fil']=='true')){
        echo 'List of '.$_GET['rent'].' vehicles between '.date("d/m/Y",strtotime($_GET['start'])).' and '.date("d/m/Y",strtotime($_GET['end'])).' whose hire rate is between TZS '.number_format($_GET['min']).' and  TZS '.number_format($_GET['max']);
    }
    elseif(($_GET['model_fil']!='true')&&($_GET['stat_fil']!='true')&&($_GET['range_fil']=='true')&&($_GET['rent_fil']!='true')){
        echo 'List of vehicles whose hire rate is between TZS '.number_format($_GET['min']).' and  TZS '.number_format($_GET['max']);
    }
    elseif(($_GET['model_fil']!='true')&&($_GET['stat_fil']!='true')&&($_GET['range_fil']!='true')&&($_GET['rent_fil']=='true')){
        echo 'List of '.$_GET['rent'].' vehicles between '.date("d/m/Y",strtotime($_GET['start'])).' and '.date("d/m/Y",strtotime($_GET['end']));
    }
    elseif(($_GET['model_fil']!='true')&&($_GET['stat_fil']!='true')&&($_GET['range_fil']!='true')&&($_GET['rent_fil']!='true')){
          echo 'List of Rental Vehicles';
    }
  } 
  elseif($_GET['report_type']=='clients'){
    if($_GET['centre_fil']=='true'){
    ...
    elseif($_GET['centre_fil']!='true' && $_GET['cont_fil']=='true' && $_GET['date_fil']=='true' && $_GET['pay_fil']!='true'){
        echo 'List of Car Rental Clients whose Contract Status is '.$_GET['cont'].' and Contract Date is Between '.date("d/m/Y",strtotime($_GET['start'])).' and '.date("d/m/Y",strtotime($_GET['end']));
      }
    elseif($_GET['centre_fil']!='true' && $_GET['cont_fil']=='true' && $_GET['date_fil']!='true' && $_GET['pay_fil']=='true'){
          echo 'List of Car Rental Clients whose Contract Status is '.$_GET['cont'].' and Payment Status is '.$_GET['pay'];
      }
    elseif($_GET['centre_fil']!='true' && $_GET['cont_fil']=='true' && $_GET['date_fil']!='true' && $_GET['pay_fil']!='true'){
          echo 'List of Car Rental Clients whose Contract Status is '.$_GET['cont'];
      }
    elseif($_GET['centre_fil']!='true' && $_GET['cont_fil']!='true' && $_GET['date_fil']=='true' && $_GET['pay_fil']=='true'){
          echo 'List of Car Rental Clients whose Payment Status is '.$_GET['pay'].' and Contract Date is Between '.date("d/m/Y",strtotime($_GET['start'])).' and '.date("d/m/Y",strtotime($_GET['end']));
      }
    elseif($_GET['centre_fil']!='true' && $_GET['cont_fil']!='true' && $_GET['date_fil']=='true' && $_GET['pay_fil']!='true'){
        echo 'List of Car Rental Clients whose Contract Date is Between '.date("d/m/Y",strtotime($_GET['start'])).' and '.date("d/m/Y",strtotime($_GET['end']));
      }
    elseif($_GET['centre_fil']!='true' && $_GET['cont_fil']!='true' && $_GET['date_fil']!='true' && $_GET['pay_fil']=='true'){
          echo 'List of Car Rental Clients whose Payment Status is '.$_GET['pay'];
      }
    else{
          echo 'List of Car Rental Clients';
      }
  }
  elseif($_GET['report_type']=='revenue'){
      echo 'CPTU Revenue Report For the Duration '.date("d/m/Y",strtotime($_GET['start_date'])).' to '.date("d/m/Y",strtotime($_GET['end_date']));
  }
  ?>';
}
...
if(urlParams.get('report_type')=='cars'){
        ...
        buttons: [
            {   extend: 'pdfHtml5',
                ...
                customize: function ( doc ) {
                  ...
                  doc.content[2].table.widths = [22, '*', 80, 80, 80];
...
var totalpdfa, pagetotalpdfa, totalpdfb, pagetotalpdfb;
if(urlParams.get('report_type')=='clients'){
  
  if(urlParams.get('pay_fil')=='true'){
    if(urlParams.get('pay')=='Partially Paid'){
        ...
        buttons: [
            {   extend: 'pdfHtml5',
                ...
                customize: function ( doc ) {
                  ...
                  doc.content[2].table.widths = [22, 130, '*', 80, 60, 60, 100, 80, 80];
                  var rowCount = doc.content[2].table.body.length;
                      for (i = 1; i < rowCount; i++) {
                         doc.content[2].table.body[i][0]=i+'.';
                      doc.content[2].table.body[i][1].alignment = 'left';
        ...
        buttons: [
            {   extend: 'pdfHtml5',
                ...
                customize: function ( doc ) {
                  ...
                  doc.content[2].table.widths = [22, 150, '*', 80, 80, 80, 120];
                  var rowCount = doc.content[2].table.body.length;
                      for (i = 1; i < rowCount; i++) {
                         doc.content[2].table.body[i][0]=i+'.';
                      doc.content[2].table.body[i][1].alignment = 'left';

...
@section('style')
    <style type="text/css">
        ...
        tfoot th, table.dataTable tfoot td {
            ...
            <div class="container" style="max-width: 100%;">
                <center><h4>
                        @if($_GET['report_type']=='sales')
                            @if(($_GET['principal_filter']=='true') && ($_GET['package_filter']=='true')&&($_GET['yr_fil']=='true'))
                                @if($_GET['insurance_typefilter']=='true')
                                    <br><br>Sales Report Whose Principal is <strong>{{$_GET['principaltype']}}</strong>, Insurance Package is <strong>{{$_GET['package']}}</strong>, Insurance Type is <strong>{{$_GET['insurance_type']}}</strong> and Commission Date is Between <strong>{{date("d/m/Y",strtotime($_GET['start']))}}</strong> and <strong>{{date("d/m/Y",strtotime($_GET['end']))}}</strong>
                                @else
                                    <br><br>Sales Report Whose Principal is <strong>{{$_GET['principaltype']}}</strong>, Insurance Package is <strong>{{$_GET['package']}}</strong> and Commission Date is Between <strong>{{date("d/m/Y",strtotime($_GET['start']))}}</strong> and <strong>{{date("d/m/Y",strtotime($_GET['end']))}}</strong>
                                @endif
                            ...
                            @elseif(($_GET['principal_filter']=='true') && ($_GET['package_filter']!='true')&&($_GET['yr_fil']=='true'))
                                ...
                                <br><br>Sales Report Whose Principal is <strong>{{$_GET['principaltype']}}</strong> and Commission Date is Between <strong>{{date("d/m/Y",strtotime($_GET['start']))}}</strong> and <strong>{{date("d/m/Y",strtotime($_GET['end']))}}</strong>
                            ...
                            @elseif(($_GET['principal_filter']!='true') && ($_GET['package_filter']=='true')&&($_GET['yr_fil']=='true'))
                                @if($_GET['insurance_typefilter']=='true')
                                    <br><br>Sales Report Whose Insurance Package is <strong>{{$_GET['package']}}</strong>, Insurance Type is <strong>{{$_GET['insurance_type']}}</strong> and Commission Date is Between <strong>{{date("d/m/Y",strtotime($_GET['start']))}}</strong> and <strong>{{date("d/m/Y",strtotime($_GET['end']))}}</strong>
                                @else
                                    <br><br>Sales Report Whose Insurance Package is <strong>{{$_GET['package']}}</strong> and Commission Date is Between <strong>{{date("d/m/Y",strtotime($_GET['start']))}}</strong> and <strong>{{date("d/m/Y",strtotime($_GET['end']))}}</strong>
                                @endif
                            ...
                            @elseif(($_GET['principal_filter']!='true') && ($_GET['package_filter']!='true')&&($_GET['yr_fil']=='true'))
                                <br><br>Sales Report Whose Commission Date is Between <strong>{{date("d/m/Y",strtotime($_GET['start']))}}</strong> and <strong>{{date("d/m/Y",strtotime($_GET['end']))}}</strong>
                        ...
                        @elseif($_GET['report_type']=='clients')
                            ...
                            @if(($_GET['principal_filter']=='true') && ($_GET['package_filter']=='true')&&($_GET['yr_fil']=='true'))
                                @if($_GET['insurance_typefilter']=='true')
                                    <br><br>List of Insurance Clients Whose Principal is <strong>{{$_GET['principaltype']}}</strong>, Insurance Package is <strong>{{$_GET['package']}}</strong>, Insurance Type is <strong>{{$_GET['insurance_type']}}</strong> and Commission Date is Between <strong>{{date("d/m/Y",strtotime($_GET['start']))}}</strong> and <strong>{{date("d/m/Y",strtotime($_GET['end']))}}</strong>
                                @else
                                    <br><br>List of Insurance Clients Whose Principal is <strong>{{$_GET['principaltype']}}</strong>, Insurance Package is <strong>{{$_GET['package']}}</strong> and Commission Date is Between <strong>{{date("d/m/Y",strtotime($_GET['start']))}}</strong> and <strong>{{date("d/m/Y",strtotime($_GET['end']))}}</strong>
                                @endif
                            ...
                            @elseif(($_GET['principal_filter']=='true') && ($_GET['package_filter']!='true')&&($_GET['yr_fil']=='true'))
                                <br><br>List of Insurance Clients Whose Principal is <strong>{{$_GET['principaltype']}}</strong> and Commission Date is Between <strong>{{date("d/m/Y",strtotime($_GET['start']))}}</strong> and <strong>{{date("d/m/Y",strtotime($_GET['end']))}}</strong>
                            ...
                            @elseif(($_GET['principal_filter']!='true') && ($_GET['package_filter']=='true')&&($_GET['yr_fil']=='true'))
                                @if($_GET['insurance_typefilter']=='true')
                                    <br><br>List of Insurance Clients Whose Insurance Package is <strong>{{$_GET['package']}}</strong>, Insurance Type is <strong>{{$_GET['insurance_type']}}</strong> and Commission Date is Between <strong>{{date("d/m/Y",strtotime($_GET['start']))}}</strong> and <strong>{{date("d/m/Y",strtotime($_GET['end']))}}</strong>

                                @else
                                    <br><br>List of Insurance Clients Whose Insurance Package is <strong>{{$_GET['package']}}</strong> and Commission Date is Between <strong>{{date("d/m/Y",strtotime($_GET['start']))}}</strong> and <strong>{{date("d/m/Y",strtotime($_GET['end']))}}</strong>
                                @endif
                            ...
                            @elseif(($_GET['principal_filter']!='true') && ($_GET['package_filter']!='true')&&($_GET['yr_fil']=='true'))
                                <br><br>List of Insurance Clients Whose Commission Date is Between <strong>{{date("d/m/Y",strtotime($_GET['start']))}}</strong> and <strong>{{date("d/m/Y",strtotime($_GET['end']))}}</strong>
...
@section('pagescript')
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            function settitle(){
                return '\n\n <?php
                    if($_GET['report_type']=='sales'){
                        if(($_GET['principal_filter']=='true') && ($_GET['package_filter']=='true')&&($_GET['yr_fil']=='true')){
                            if($_GET['insurance_typefilter']=='true'){
                                echo 'Sales Report Whose Principal is '.$_GET['principaltype'].', Insurance Package is '.$_GET['package'].', Insurance Type is '.$_GET['insurance_type'].' and Commission Date is Between '.date("d/m/Y",strtotime($_GET['start'])).' and '.date("d/m/Y",strtotime($_GET['end']));

                            }
                            else{

                                echo 'Sales Report Whose Principal is '.$_GET['principaltype'].', Insurance Package is '.$_GET['package'].' and Commission Date is Between '.date("d/m/Y",strtotime($_GET['start'])).' and '.date("d/m/Y",strtotime($_GET['end']));
                            }
                        }

                        elseif(($_GET['principal_filter']=='true') && ($_GET['package_filter']=='true')&&($_GET['yr_fil']!='true')){
                            if($_GET['insurance_typefilter']=='true'){
                                echo 'Sales Report Whose Principal is '.$_GET['principaltype'].', Insurance Package is '.$_GET['package'].' and Insurance Type is '.$_GET['insurance_type'];
                            }
                            else{
                        ...
                        elseif(($_GET['principal_filter']=='true') && ($_GET['package_filter']!='true')&&($_GET['yr_fil']=='true')){
                            echo 'Sales Report Whose Principal is '.$_GET['principaltype'].' and Commission Date is Between '.date("d/m/Y",strtotime($_GET['start'])).' and '.date("d/m/Y",strtotime($_GET['end']));
                        }
                        ...
                        elseif(($_GET['principal_filter']!='true') && ($_GET['package_filter']=='true')&&($_GET['yr_fil']=='true')){
                            if($_GET['insurance_typefilter']=='true'){
                                echo 'Sales Report Whose Insurance Package is '.$_GET['package'].', Insurance Type is '.$_GET['insurance_type'].' and Commission Date is Between '.date("d/m/Y",strtotime($_GET['start'])).' and '.date("d/m/Y",strtotime($_GET['end']));
                            }
                            else{
                                echo 'Sales Report Whose Insurance Package is '.$_GET['package'].' and Commission Date is Between '.date("d/m/Y",strtotime($_GET['start'])).' and '.date("d/m/Y",strtotime($_GET['end']));
                            }
                        }

                        elseif(($_GET['principal_filter']!='true') && ($_GET['package_filter']=='true')&&($_GET['yr_fil']!='true')){
                            if($_GET['insurance_typefilter']=='true'){
                                echo 'Sales Report Whose Insurance Package is '.$_GET['package'].' and Insurance Type is '.$_GET['insurance_type'];
                            }
                            else{
                                echo 'Sales Report Whose Insurance Package is '.$_GET['package'];
                            }
                        }

                        elseif(($_GET['principal_filter']!='true') && ($_GET['package_filter']!='true')&&($_GET['yr_fil']=='true')){
                            echo 'Sales Report Whose Commission Date is Between '.date("d/m/Y",strtotime($_GET['start'])).' and '.date("d/m/Y",strtotime($_GET['end']));
                        }

                        elseif(($_GET['principal_filter']!='true') && ($_GET['package_filter']!='true')&&($_GET['yr_fil']!='true')){
                            echo 'Insurance Sales Report';
                        }
                    }

                    elseif($_GET['report_type']=='principals'){
                        echo 'List of Insurance Principals';
                    }
                    ...
                    elseif($_GET['report_type']=='clients'){
                        ...
                        if(($_GET['principal_filter']=='true') && ($_GET['package_filter']=='true')&&($_GET['yr_fil']=='true')){
                            if($_GET['insurance_typefilter']=='true'){
                                echo 'List of Insurance Clients Whose Principal is '.$_GET['principaltype'].', Insurance Package is '.$_GET['package'].', Insurance Type is '.$_GET['insurance_type'].' and Commission Date is Between '.date("d/m/Y",strtotime($_GET['start'])).' and '.date("d/m/Y",strtotime($_GET['end']));
                            }
                            else{
                                echo 'List of Insurance Clients Whose Principal is '.$_GET['principaltype'].', Insurance Package is '.$_GET['package'].' and Commission Date is Between '.date("d/m/Y",strtotime($_GET['start'])).' and '.date("d/m/Y",strtotime($_GET['end']));
                            }
                        }

                        elseif(($_GET['principal_filter']=='true') && ($_GET['package_filter']=='true')&&($_GET['yr_fil']!='true')){
                            if($_GET['insurance_typefilter']=='true'){
                                echo 'List of Insurance Clients Whose Principal is '.$_GET['principaltype'].', Insurance Package is '.$_GET['package'].' and Insurance Type is '.$_GET['insurance_type'];
                            }
                            else{
                                echo 'List of Insurance Clients Whose Principal is '.$_GET['principaltype'].' and Insurance Package is '.$_GET['package'];
                            }
                        }

                        elseif(($_GET['principal_filter']=='true') && ($_GET['package_filter']!='true')&&($_GET['yr_fil']=='true')){
                            echo 'List of Insurance Clients Whose Principal is '.$_GET['principaltype'].' and Commission Date is Between '.date("d/m/Y",strtotime($_GET['start'])).' and '.date("d/m/Y",strtotime($_GET['end']));
                        }

                        elseif(($_GET['principal_filter']=='true') && ($_GET['package_filter']!='true')&&($_GET['yr_fil']!='true')){
                            echo 'List of Insurance Clients Whose Principal is '.$_GET['principaltype'];
                        }

                        elseif(($_GET['principal_filter']!='true') && ($_GET['package_filter']=='true')&&($_GET['yr_fil']=='true')){
                            if($_GET['insurance_typefilter']=='true'){
                                echo 'List of Insurance Clients Whose Insurance Package is '.$_GET['package'].', Insurance Type is '.$_GET['insurance_type'].' and Commission Date is Between '.date("d/m/Y",strtotime($_GET['start'])).' and '.date("d/m/Y",strtotime($_GET['end']));
                            }
                            else{
                                echo 'List of Insurance Clients Whose Insurance Package is '.$_GET['package'].' and Commission Date is Between '.date("d/m/Y",strtotime($_GET['start'])).' and '.date("d/m/Y",strtotime($_GET['end']));
                            }
                        }

                        elseif(($_GET['principal_filter']!='true') && ($_GET['package_filter']=='true')&&($_GET['yr_fil']!='true')){
                            if($_GET['insurance_typefilter']=='true'){
                                echo 'List of Insurance Clients Whose Insurance Package is '.$_GET['package'].' and Insurance Type is '.$_GET['insurance_type'];
                            }
                            else{
                                echo 'List of Insurance Clients Whose Insurance Package is '.$_GET['package'];
                            }
                        }

                        elseif(($_GET['principal_filter']!='true') && ($_GET['package_filter']!='true')&&($_GET['yr_fil']=='true')){
                            echo 'List of Insurance Clients Whose Commission Date is Between '.date("d/m/Y",strtotime($_GET['start'])).' and '.date("d/m/Y",strtotime($_GET['end']));

                        }

                        elseif(($_GET['principal_filter']!='true') && ($_GET['package_filter']!='true')&&($_GET['yr_fil']!='true')){
                            echo 'List of Insurance Clients';
                        }
            ...
            var premiumpdf,premiumpdf2, actualpdf, commissionpdf;
                ...
                buttons: [
                    {   extend: 'pdfHtml5',
                        ...
                        customize: function ( doc ) {
                            ...
                            doc.content[2].table.widths = [22, '*', 80, 60, 60, 100, 70, 70,70];
                            ...
                            //             widths: ['*',50, 49, 80, 79],
                            //             body: [
                            //             [{text: 'TOTAL',  colSpan: 2, rowSpan: 2, alignment: 'left'}, {}, {text: 'TZS', alignment: 'center'},{text: premiumpdf2, alignment: 'right'}, {text:  '', alignment: 'right'}],
                            //             [{}, {}, {text: 'USD', alignment: 'center'},{text: premiumpdf, alignment: 'right'}, {text: '', alignment: 'right'}]
                            //           ]
                            //     }
                            // });
                        }
                ...
                buttons: [
                    {   extend: 'pdfHtml5',
                        ...
                        customize: function ( doc ) {
                            ...
                            doc.content[2].table.widths = [22, '*', 80, 150, 70, 70, 70, 70];
                            var rowCount = doc.content[2].table.body.length;
                            for (i = 1; i < rowCount; i++) {
                                doc.content[2].table.body[i][0]=i+'.';
                                doc.content[2].table.body[i][1].alignment = 'left';

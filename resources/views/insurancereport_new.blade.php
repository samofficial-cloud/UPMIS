        ...
        <tr>
         ...
         {{--  <th scope="col" style="width: 12%;"><center>Sum Insured</center></th> --}}
          <th scope="col" style="width: 12%;"><center>Premium (TZS)</center></th>
            ...
            <th scope="col" style="width: 12%;"><center>Commission</center></th>
...
function settitle(){
    return '\n\n <?php
       if($_GET['report_type']=='sales'){
          if(($_GET['principal_filter']=='true') && ($_GET['package_filter']=='true')&&($_GET['yr_fil']=='true')){
              if($_GET['insurance_typefilter']=='true'){
                if($_GET['yr_cat']=='start'){
                  echo 'Sales Report Whose Principal is '.$_GET['principaltype'].', Insurance Package is '.$_GET['package'].', Insurance Type is '.$_GET['insurance_type'].' and Commission Year is '.$_GET['yr'];
                  }
                elseif($_GET['yr_cat']=='end'){
                  echo 'Sales Report Whose Principal is '.$_GET['principaltype'].', Insurance Package is '.$_GET['package'].', Insurance Type is '.$_GET['insurance_type'].' and Expiry Year is '.$_GET['yr'];
                }
              }
              else{
                if($_GET['yr_cat']=='start'){
                  echo 'Sales Report Whose Principal is '.$_GET['principaltype'].', Insurance Package is '.$_GET['package'].' and Commission Year is '.$_GET['yr'];
                }
                elseif($_GET['yr_cat']=='end'){
                  echo 'Sales Report Whose Principal is '.$_GET['principaltype'].', Insurance Package is '.$_GET['package'].' and Expiry Year is '.$_GET['yr'];
                }
              }
            }
    ...
    elseif(($_GET['principal_filter']=='true') && ($_GET['package_filter']!='true')&&($_GET['yr_fil']=='true')){
      if($_GET['yr_cat']=='start'){
         echo 'Sales Report Whose Principal is '.$_GET['principaltype'].' and Commission Year is '.$_GET['yr'];
       }
      elseif($_GET['yr_cat']=='end'){
    ...
    elseif(($_GET['principal_filter']!='true') && ($_GET['package_filter']=='true')&&($_GET['yr_fil']=='true')){
      if($_GET['insurance_typefilter']=='true'){
          if($_GET['yr_cat']=='start'){
            echo 'Sales Report Whose Insurance Package is '.$_GET['package'].', Insurance Type is '.$_GET['insurance_type'].' and Commission Year is '.$_GET['yr'];
          }
         elseif($_GET['yr_cat']=='end'){
          echo 'Sales Report Whose Insurance Package is '.$_GET['package'].', Insurance Type is '.$_GET['insurance_type'].' and Expiry Year is '.$_GET['yr'];
         }
      }
      else{
         if($_GET['yr_cat']=='start'){
         echo 'Sales Report Whose Insurance Package is '.$_GET['package'].' and Commission Year is '.$_GET['yr'];
          }
         elseif($_GET['yr_cat']=='end'){
         echo 'Sales Report Whose Insurance Package is '.$_GET['package'].' and Expiry Year is '.$_GET['yr'];
          }
      }
    }
  ...
  elseif(($_GET['principal_filter']!='true') && ($_GET['package_filter']!='true')&&($_GET['yr_fil']=='true')){
    if($_GET['yr_cat']=='start'){
     echo 'Sales Report Whose Commission Year is '.$_GET['yr'];
    }
    elseif($_GET['yr_cat']=='end'){
     echo 'Sales Report Whose Expiry Year is '.$_GET['yr'];
    }
  }
...
elseif($_GET['report_type']=='clients'){
  ...
  if(($_GET['principal_filter']=='true') && ($_GET['package_filter']=='true')&&($_GET['yr_fil']=='true')){
      if($_GET['insurance_typefilter']=='true'){
        if($_GET['yr_cat']=='start'){
          echo 'List of Insurance Clients Whose Principal is '.$_GET['principaltype'].', Insurance Package is '.$_GET['package'].', Insurance Type is '.$_GET['insurance_type'].' and Commission Year is '.$_GET['yr'];
        }
        elseif($_GET['yr_cat']=='end'){
         echo 'List of Insurance Clients Whose Principal is '.$_GET['principaltype'].', Insurance Package is '.$_GET['package'].', Insurance Type is '.$_GET['insurance_type'].' and Expiry Year is '.$_GET['yr'];
        }
      }
      else{
        if($_GET['yr_cat']=='start'){
         echo 'List of Insurance Clients Whose Principal is '.$_GET['principaltype'].', Insurance Package is '.$_GET['package'].' and Commission Year is '.$_GET['yr'];
        }
        elseif($_GET['yr_cat']=='end'){
         echo 'List of Insurance Clients Whose Principal is '.$_GET['principaltype'].', Insurance Package is '.$_GET['package'].' and Expiry Year is '.$_GET['yr'];
        }
      }
  }
  ...
  elseif(($_GET['principal_filter']=='true') && ($_GET['package_filter']!='true')&&($_GET['yr_fil']=='true')){
      if($_GET['yr_cat']=='start'){
         echo 'List of Insurance Clients Whose Principal is '.$_GET['principaltype'].' and Commission Year is '.$_GET['yr'];
      }
      elseif($_GET['yr_cat']=='end'){
         echo 'List of Insurance Clients Whose Principal is '.$_GET['principaltype'].' and Expiry Year is '.$_GET['yr'];
      }
  }
  ...
  elseif(($_GET['principal_filter']!='true') && ($_GET['package_filter']=='true')&&($_GET['yr_fil']=='true')){
      if($_GET['insurance_typefilter']=='true'){
          if($_GET['yr_cat']=='start'){
            echo 'List of Insurance Clients Whose Insurance Package is '.$_GET['package'].', Insurance Type is '.$_GET['insurance_type'].' and Commission Year is '.$_GET['yr'];
          }
         elseif($_GET['yr_cat']=='end'){
         ...
         elseif($_GET['yr_cat']=='end'){
          echo 'List of Insurance Clients Whose Insurance Package is '.$_GET['package'].' and Expiry Year is '.$_GET['yr'];
          }
      }
  }
  ...
  elseif(($_GET['principal_filter']!='true') && ($_GET['package_filter']!='true')&&($_GET['yr_fil']=='true')){
      if($_GET['yr_cat']=='start'){
       echo 'List of Insurance Clients Whose Commission Year is '.$_GET['yr'];
      }
      elseif($_GET['yr_cat']=='end'){
       echo 'List of Insurance Clients Whose Expiry Year is '.$_GET['yr'];
      }
   }
   ...
   var table = $('#myTable').DataTable({
           ...
           "footerCallback": function ( row, data, start, end, display ) {
            ...
            $( api.column( 6 ).footer() ).html(
              'Current: '+$.fn.dataTable.render.number(',').display(pagepremium)+'<hr style="margin-bottom:5px; margin-top: 5px;">'+' Out of: ' +$.fn.dataTable.render.number(',').display(premium)
               
            );

            $( api.column( 7 ).footer() ).html(
              'Current: '+$.fn.dataTable.render.number(',').display(pageactual)+'<hr style="margin-bottom:5px; margin-top: 5px;">'+' Out of: ' +$.fn.dataTable.render.number(',').display(actual)
               
            );

            $( api.column( 8 ).footer() ).html(
              'Current: '+$.fn.dataTable.render.number(',').display(pagecommission)+'<hr style="margin-bottom:5px; margin-top: 5px;">'+' Out of: ' +$.fn.dataTable.render.number(',').display(commission)

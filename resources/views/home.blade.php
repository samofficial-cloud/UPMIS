...
<div class="container">
  ...
  <a data-toggle="modal" data-target="#space" class="btn button_color active" style="background-color: lightgrey; padding: 10px; margin-left: -16px; margin-bottom: 8px;" role="button" aria-pressed="true">Add New Space</a>
  <br>
  ...
  <div class="row justify-content-center">
      <div class="modal fade" id="space" role="dialog">
        ...
        <div class="form-group">
           <center><button type="submit" class="btn btn-primary" id="newdata">Save</button></center>
          </div>

    ...
    <center><h4>
      @if($_GET['report_type']=='rooms')
        @if($_GET['room_fil']=='true')
          <br><br>List of Research Flats Rooms whose category is {{$_GET['room']}}
        @else
           <br><br>List of Research Flats Rooms
        @endif
      @elseif($_GET['report_type']=='contracts')
        @if($_GET['pay_fil']=='true' && $_GET['stat_fil']=='true')
          <br><br>List of {{$_GET['pay']}} {{$_GET['status']}} Research Flats Contracts
        @elseif($_GET['pay_fil']=='true' && $_GET['stat_fil']!='true')
          <br><br>List of {{$_GET['pay']}} Research Flats Contracts
        @elseif($_GET['pay_fil']!='true' && $_GET['stat_fil']=='true')
          <br><br>List of {{$_GET['status']}} Research Flats Contracts
        @elseif($_GET['pay_fil']!='true' && $_GET['stat_fil']!='true')
          <br><br>List of Research Flats Contracts
        @endif
      @endif
    </h4></center>
    <hr>
      ...
      <table class="hover table table-striped table-bordered" id="myTableResearch">
                        ...
                        @foreach($contracts as $var)
                            <tr>
                              ...
                              @elseif($_GET['pay']=='Paid')
                              @elseif($_GET['pay']=='Partially Paid')
                                <td style="text-align: right;">{{$var->currency_invoice}} {{number_format($var->amount_paid)}}</td>
                                <td style="text-align: right;">{{$var->currency_invoice}} {{number_format($var->amount_not_paid)}}</td>
                              @endif
                            </tr>
                              <?php $r = $r+1; ?>
...
var base64 = '';
  ...
  function settitle(){
    return '\n\n <?php
      if($_GET['report_type']=='rooms'){
        if($_GET['room_fil']=='true'){
          echo 'List of Research Flats Rooms whose category is '.$_GET['room'];
        }
        else{
           echo 'List of Research Flats Rooms';
        }
      }
      elseif($_GET['report_type']=='contracts'){
        if($_GET['pay_fil']=='true' && $_GET['stat_fil']=='true'){
          echo 'List of '.$_GET['pay'].' '.$_GET['status'].' Research Flats Contracts';
        }
        elseif($_GET['pay_fil']=='true' && $_GET['stat_fil']!='true'){
          echo 'List of '.$_GET['pay'].' Research Flats Contracts';
        }
        elseif($_GET['pay_fil']!='true' && $_GET['stat_fil']=='true'){
          echo 'List of '.$_GET['status'].' Research Flats Contracts';
        }
        elseif($_GET['pay_fil']!='true' && $_GET['stat_fil']!='true'){
          echo 'List of Research Flats Contracts';
        }
      }
    ?>'
  }
   ...
   const queryString2 = window.location.search;
    ...
    var filter = urlPay.get('room_fil');
    var payment =  urlPay.get('pay');
         ...
         buttons: [
            {   extend: 'pdfHtml5',
                ...
                customize: function ( doc ) {
                  ...
                  doc.content[2].table.widths = [22, '*', 100, 100, 100];
        ...
        dom: '<"top"fl><"top"<"pull-right" B>>rt<"bottom"pi>',
            ...
            {   extend: 'pdfHtml5',
                ...
                customize: function ( doc ) {
                  ...
                  doc.content[2].table.widths = [22, '*', 120, 80, 80, 100, 80, 80];
                  var rowCount = doc.content[2].table.body.length;
                      for (i = 1; i < rowCount; i++) {
                      doc.content[2].table.body[i][0]=i+'.';
                      doc.content[2].table.body[i][1].alignment = 'left';
        ...
        dom: '<"top"fl><"top"<"pull-right" B>>rt<"bottom"pi>',
            ...
            {   extend: 'pdfHtml5',
                ...
                customize: function ( doc ) {
                  ...
                  doc.content[2].table.widths = [22, '*', 120, 80, 80, 90, 80, 80];
                  var rowCount = doc.content[2].table.body.length;
                      for (i = 1; i < rowCount; i++) {
                      doc.content[2].table.body[i][0]=i+'.';
                      doc.content[2].table.body[i][1].alignment = 'left';
        ...
        dom: '<"top"fl><"top"<"pull-right" B>>rt<"bottom"pi>',
            ...
            {   extend: 'pdfHtml5',
                ...
                customize: function ( doc ) {
                  ...
                  doc.content[2].table.widths = [22, '*', 80, 65, 65, 60, 75, 75, 75, 80];
                  var rowCount = doc.content[2].table.body.length;
                      for (i = 1; i < rowCount; i++) {
                      doc.content[2].table.body[i][0]=i+'.';
                      doc.content[2].table.body[i][1].alignment = 'left';

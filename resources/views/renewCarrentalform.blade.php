...
<div class="container-fluid" id="grad1">
    ...
    <div class="form-group">
        ...
        <div class="form-group row" id="namediv" style="display: none;">
						...
						<div class="form-wrapper col-6">
							...
							<input type="text" id="last_name" name="last_name" value="{{$contract->last_name}}" class="form-control" readonly="">
						</div>
					</div>
					...
					<div class="form-wrapper">
						...
						<input type="text" id="company_name" name="company_name" class="form-control" value="{{$contract->fullName}}" readonly="">
					</div>
				</div>
 ...
 <input type="button" name="next" id="next1" class="next action-button" value="Next Step" />
					...
					<div class="form-wrapper">
						...
						<input type="text" id="vehicle_reg" name="vehicle_reg" class="form-control" value="">
				...
				<div class="form-group">
					<div class="form-wrapper">
						...
						<input type="text" id="vehiclemodel" name="vehiclemodel" class="form-control" value="" readonly="">
					</div>
				</div>
				...
				<div class="form-group">
					<div class="form-wrapper">
						...
						<input type="text" id="hirerate" name="hirerate" class="form-control" value=" " readonly="">
					</div>
				</div>
				...
				<div class="form-group">
					<div class="form-wrapper">
						...
						<input type="textarea" id="condition" name="condition" class="form-control" value="">
					</div>
				</div>
				...
				<div class="form-group row">
						<div class="form-wrapper col-6">
							...
							<input type="date" id="start_date" name="start_date" class="form-control" required="" value="" min="{{$today}}">
						</div>
						<div class="form-wrapper col-6">
							<label for="end_date">End Date*</label>
							<input type="date" id="end_date" name="end_date" class="form-control" required="" value="" min="{{$today}}">
						</div>
					</div>
					...
					<div class="form-wrapper col-6">
						...
						<select class="form-control" required="" id="currency" name="currency" required="">
                         <option value="0" disabled selected hidden>Select Currency</option>

  ...
  <div class="container" style="max-width: 100%;">
    ...
    <table class="hover table table-striped  table-bordered" id="myTableCar">
                            ...
                            <tr>
                                ...
                                <th scope="col"  style="color:#fff;width: 15%;">Client Name</th>
                      ...
                      <tbody>
                            ...
                            @foreach($invoices as $var)
                                <tr>
                                    ...
                                    <td><center>{{date("d/m/Y",strtotime($var->invoice_date))}} @if($var->email_sent_status=='NOT SENT')
              ...
              <table class="hover table table-striped  table-bordered" id="myTable2">
                            ...
                            @foreach($payments as $var)
                                <tr>
                                    ...
                                    <td>{{$var->debtor_name}}</td>
                                    <td><center>{{$var->invoice_number}}</center></td>
                                    @if($var->invoice_number_votebook==null)
          ...
          var table = $('#myTable2').DataTable( {
            ...
            {   extend: 'pdfHtml5',
                ...
                customize: function ( doc ) {
                  ...
                  doc.content[2].table.widths=[22, '*', 100, 80, 100, 100, 80, 80];
                  var rowCount = doc.content[2].table.body.length;
                      for (i = 1; i < rowCount; i++) {
                         doc.content[2].table.body[i][0]=i+'.';
                         doc.content[2].table.body[i][1].alignment = 'left';

     ...
     {{--  <th scope="col"><center>Client Type</center></th> --}}
      ...
      @elseif($_GET['contract_filter']!='true' && $_GET['payment_filter']=='true')
        ...
        <th scope="col"><center>Currency</center></th>
          ...
          @elseif($_GET['payment_status']=='Not paid')
...
function settitle(){
  ...
  if($_GET['report_type']=='list'){
    if(($_GET['business_filter']=='true') && ($_GET['contract_filter']=='true') && ($_GET['payment_filter']=='true')){
      if(($_GET['contract_status']==1)){
        echo 'List of Active Tenants who have '.$_GET['payment_status'].' for the Duration from '.date("d/m/Y",strtotime($_GET['start_date'])).' to '.date("d/m/Y",strtotime($_GET['end_date'])).' and whose Business Type is '.$_GET['business_type'];
      }

      elseif(($_GET['contract_status']==-1)){
        echo 'List of Terminated Tenants who have '.$_GET['payment_status'].' for the Duration from '.date("d/m/Y",strtotime($_GET['start_date'])).' to '.date("d/m/Y",strtotime($_GET['end_date'])).' and Whose Business Type was '.$_GET['business_type'];
      }
      elseif(($_GET['contract_status'] ==0)){
        echo 'List of Tenants whose Contract has Expired and who have '.$_GET['payment_status'].' for the Duration from '.date("d/m/Y",strtotime($_GET['start_date'])).' to '.date("d/m/Y",strtotime($_GET['end_date'])).' and whose Business Type was '.$_GET['business_type'];
      }
    }

    if(($_GET['business_filter']=='true') && ($_GET['contract_filter']=='true') && ($_GET['payment_filter']!='true')){
      if($_GET['contract_status']==1){
        echo 'List of Active Tenants Whose Business Type is '.$_GET['business_type'];
      }
      elseif($_GET['contract_status']==0){
        echo 'List of Tenants whose Contract has Expired and whose Business Type was '.$_GET['business_type'];
      }
      elseif($_GET['contract_status']==-1){
        echo 'List of Terminated Tenants whose Business Type was '.$_GET['business_type'];

      }
    }

    if(($_GET['business_filter']=='true') && ($_GET['contract_filter']!='true') && ($_GET['payment_filter']=='true')){
     echo 'List of Tenants who have '.$_GET['payment_status'].' for the Duration from '.date("d/m/Y",strtotime($_GET['start_date'])).' to '.date("d/m/Y",strtotime($_GET['end_date'])).' and Whose Business Type is '.$_GET['business_type'];
    }

  if(($_GET['business_filter']=='true') && ($_GET['contract_filter']!='true') && ($_GET['payment_filter']!='true')){
    echo 'List of Tenants Whose Business Type is '.$_GET['business_type'];
  }

  if(($_GET['business_filter']!='true') && ($_GET['contract_filter']=='true') && ($_GET['payment_filter']=='true')){
    if(($_GET['contract_status']==1)){
     echo 'List of Active Tenants who have '.$_GET['payment_status'].' for the Duration from '.date("d/m/Y",strtotime($_GET['start_date'])).' to '.date("d/m/Y",strtotime($_GET['end_date']));
    }

    elseif(($_GET['contract_status']==-1)){
      echo 'List of Terminated Tenants who have '.$_GET['payment_status'].' for the Duration from '.date("d/m/Y",strtotime($_GET['start_date'])).' to '.date("d/m/Y",strtotime($_GET['end_date']));
    }

    elseif(($_GET['contract_status']==0)){
     echo 'List of Tenants whose Contract has Expired who have '.$_GET['payment_status'].' for the Duration from '.date("d/m/Y",strtotime($_GET['start_date'])).' to '.date("d/m/Y",strtotime($_GET['end_date']));
    }
  }
  ...
  if(($_GET['business_filter']!='true') && ($_GET['contract_filter']=='true') && ($_GET['payment_filter']!='true')){
    ...
    elseif($_GET['contract_status']==0){
      echo 'List of Tenants whose Contract has Expired';
    }

    elseif($_GET['contract_status']==-1){
     echo 'List of Terminated Tenants';
    }

}

  if(($_GET['business_filter']!='true') && ($_GET['contract_filter']!='true') && ($_GET['payment_filter']=='true')){
    echo 'List of Tenants who have '.$_GET['payment_status'].' for the Duration from '.date("d/m/Y",strtotime($_GET['start_date'])).' to '.date("d/m/Y",strtotime($_GET['end_date']));
  }
...
elseif($_GET['report_type']=='invoice'){
  if($_GET['payment_filter']=='true'){
    if($_GET['criteria']=='rent'){
      echo 'List of '.$_GET['payment_status'].' Rent Invoices for the Duration from '.date("d/m/Y",strtotime($_GET['start_date'])).' to '.date("d/m/Y",strtotime($_GET['end_date']));
    }

    elseif($_GET['criteria']=='electricity'){
      echo 'List of '.$_GET['payment_status'].' Electricity Invoices for the Duration from '.date("d/m/Y",strtotime($_GET['start_date'])).' to '.date("d/m/Y",strtotime($_GET['end_date'])).' Invoices';
    }

    elseif($_GET['criteria']=='water'){
      echo 'List of '.$_GET['payment_status'].' Water Invoices for the Duration from '.date("d/m/Y",strtotime($_GET['start_date'])).' to '.date("d/m/Y",strtotime($_GET['end_date']));
    }
  }
  else{
    if($_GET['criteria']=='rent'){
      echo 'List of Rent Invoices for the Duration from '.date("d/m/Y",strtotime($_GET['start_date'])).' to '.date("d/m/Y",strtotime($_GET['end_date']));
    }
    elseif($_GET['criteria']=='electricity'){
      echo 'List of Electricity Invoices for the Duration from '.date("d/m/Y",strtotime($_GET['start_date'])).' to '.date("d/m/Y",strtotime($_GET['end_date']));
    }
    elseif($_GET['criteria']=='water'){
      echo 'List of Water Invoices for the Duration from '.date("d/m/Y",strtotime($_GET['start_date'])).' to '.date("d/m/Y",strtotime($_GET['end_date']));
    }
        ...
        buttons: [
            {   extend: 'pdfHtml5',
                ...
                customize: function ( doc ) {
                  ...
                  doc.content[2].table.widths = [22, '*', 60, 65, 115, 70, 60, 50, 70, 60];
                  var rowCount = doc.content[2].table.body.length;
                      for (i = 1; i < rowCount; i++) {
                         doc.content[2].table.body[i][0]=i+'.';
                      doc.content[2].table.body[i][1].alignment = 'left';
        ...
        buttons: [
            {   extend: 'pdfHtml5',
                ...
                customize: function ( doc ) {
                  ...
                  doc.content[2].table.widths = [22, '*', 60, 60, 60, 60, 80, 60, 55, 70, 60];
                  var rowCount = doc.content[2].table.body.length;
                      for (i = 1; i < rowCount; i++) {
                         doc.content[2].table.body[i][0]=i+'.';
                      doc.content[2].table.body[i][1].alignment = 'left';

...
<script type="text/javascript">
  function settitle(){
    return '\n \n Solicited Contract(s) that are about to expire (Within 31 days prior to date)';
  }

  function settitle2(){
    return '\n \n Solicited Contract(s) that are about to expire';
  }
   ...
   dom: '<"top"fl><"top"<"pull-right"B>>rt<"bottom"pi>',
            buttons: [
                {   extend: 'pdfHtml5',
                    ...
                    customize: function ( doc ) {
                      ...
                      doc.content[1].table.widths = [22, '*', 70, 100, 100, 100,'*'];
            ...
            fillColor: function (rowIndex, node, columnIndex) {
              return (rowIndex % 2 === 0) ? '#ffffff' : '#ffffff';
                        ...
                        margin: [ 0, 0, 0, 12 ],
                        alignment: 'center',
                         text: 'DIRECTORATE OF PLANNING, DEVELOPMENT AND INVESTIMENT'+settitle()
                    } );
                    }
                },
                {   extend: 'excelHtml5',
  ...
  var table2 = $('#myTable').DataTable();
    ...
    return false;
        ...
        $("#contract_filter").click(function(e){
            e.preventDefault();
            var query = $('#contract_month').val();
            var _token = $('input[name="_token"]').val();

            $.ajax({
              url: "/home16/contract_filter?",
              context: document.body,
              data:{mon:query, _token:_token}
              })
            ...
            fillColor: function (rowIndex, node, columnIndex) {
              return (rowIndex % 2 === 0) ? '#ffffff' : '#ffffff';
                        ...
                        margin: [ 0, 0, 0, 12 ],
                        alignment: 'center',
                         text: 'DIRECTORATE OF PLANNING, DEVELOPMENT AND INVESTIMENT'+settitle2()
                    } );
                    }
                },
                {   extend: 'excelHtml5',

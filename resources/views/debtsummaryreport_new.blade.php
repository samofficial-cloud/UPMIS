...
<center><h4>
  ...
  @if($_GET['show']=='clients')
    <table class="hover table table-striped table-bordered" id="spaceTable">
      ...
      <tbody>
       ...
       <tfoot class="table-striped table-bordered">
            <tr>
                <th colspan="5" rowspan="2" style="text-align:left">TOTAL</th>
...
@elseif($_GET['b_type']=='Insurance')
<table class="hover table table-striped table-bordered" id="insuranceTable">
      <thead class="thead-dark">
        <tr>
      ...
      <tfoot class="table-striped table-bordered">
            <tr>
                <th colspan="2" rowspan="2" style="text-align:left">TOTAL</th>
                <th style="text-align: center;"></th>
                <th style="text-align: right;"></th>
                <th style="text-align: right;"></th>
            </tr>
...
function settitle(){
  ...
  if($_GET['b_type']=='Space'){
        if($_GET['criteria']=='space'){
          if(($_GET['bus_fil']=='true') && ($_GET['loc_fil']=='true') && ($_GET['yr_fil']=='true')){
            echo 'Real Estate Revenue Collection and Debts Summary of the Duration '.date("d/m/Y",strtotime($_GET["start"])).' to '.date("d/m/Y",strtotime($_GET["end"])).', for Rent, whose business is '.$_GET["biz"].' and  Location is '.$_GET["loc"];
          }
            ...
            echo 'Real Estate Revenue Collection and Debts Summary of the Duration '.date("d/m/Y",strtotime($_GET["start"])).' to '.date("d/m/Y",strtotime($_GET["end"])).', for Rent and whose Location is '.$_GET["loc"];
          }
          else if(($_GET['bus_fil']!='true') && ($_GET['loc_fil']=='true') && ($_GET['yr_fil']!='true')){
            echo 'Real Estate Revenue Collection and Debts Summary for Rent and Location is '.$_GET["loc"];
          }
          else if(($_GET['bus_fil']!='true') && ($_GET['loc_fil']!='true') && ($_GET['yr_fil']=='true')){
            echo 'Real Estate Revenue Collection and Debts Summary of the Duration '.date("d/m/Y",strtotime($_GET["start"])).' to '.date("d/m/Y",strtotime($_GET["end"])).', for Rent';
          }
          else if(($_GET['bus_fil']!='true') && ($_GET['loc_fil']!='true') && ($_GET['yr_fil']!='true')){
            echo 'Real Estate Revenue Collection and Debts Summary for Rent';
          }
        }

        else if($_GET['criteria']=='electricity'){
          if(($_GET['bus_fil']=='true') && ($_GET['loc_fil']=='true') && ($_GET['yr_fil']=='true')){
            echo 'Real Estate Revenue Collection and Debts Summary of the Duration '.date("d/m/Y",strtotime($_GET["start"])).' to '.date("d/m/Y",strtotime($_GET["end"])).', for Electricity, whose business is '.$_GET["biz"].' and  Location is '.$_GET["loc"];
          }
          else if(($_GET['bus_fil']=='true') && ($_GET['loc_fil']=='true') && ($_GET['yr_fil']!='true')){
            ...
            echo 'Real Estate Revenue Collection and Debts Summary of the Duration '.date("d/m/Y",strtotime($_GET["start"])).' to '.date("d/m/Y",strtotime($_GET["end"])).', for Electricity and whose Location is '.$_GET["loc"];
          }
          else if(($_GET['bus_fil']!='true') && ($_GET['loc_fil']=='true') && ($_GET['yr_fil']!='true')){
            echo 'Real Estate Revenue Collection and Debts Summary for Electricity and Location is '.$_GET["loc"];
          }
          else if(($_GET['bus_fil']!='true') && ($_GET['loc_fil']!='true') && ($_GET['yr_fil']=='true')){
            echo 'Real Estate Revenue Collection and Debts Summary of the Duration '.date("d/m/Y",strtotime($_GET["start"])).' to '.date("d/m/Y",strtotime($_GET["end"])).', for Electricity';
          }
          else if(($_GET['bus_fil']!='true') && ($_GET['loc_fil']!='true') && ($_GET['yr_fil']!='true')){
            echo 'Real Estate Revenue Collection and Debts Summary for Electricity';
          }
        }

        else if($_GET['criteria']=='water'){
          if(($_GET['bus_fil']=='true') && ($_GET['loc_fil']=='true') && ($_GET['yr_fil']=='true')){
            echo 'Real Estate Revenue Collection and Debts Summary of the Duration '.date("d/m/Y",strtotime($_GET["start"])).' to '.date("d/m/Y",strtotime($_GET["end"])).', for water, whose business is '.$_GET["biz"].' and  Location is '.$_GET["loc"];
          }
          else if(($_GET['bus_fil']=='true') && ($_GET['loc_fil']=='true') && ($_GET['yr_fil']!='true')){
            ...
            echo 'Real Estate Revenue Collection and Debts Summary of the Duration '.date("d/m/Y",strtotime($_GET["start"])).' to '.date("d/m/Y",strtotime($_GET["end"])).', for water and whose Location is '.$_GET["loc"];
          }
          else if(($_GET['bus_fil']!='true') && ($_GET['loc_fil']=='true') && ($_GET['yr_fil']!='true')){
            echo 'Real Estate Revenue Collection and Debts Summary for water and Location is '.$_GET["loc"];
          }
          else if(($_GET['bus_fil']!='true') && ($_GET['loc_fil']!='true') && ($_GET['yr_fil']=='true')){
            echo 'Real Estate Revenue Collection and Debts Summary of the Duration '.date("d/m/Y",strtotime($_GET["start"])).' to '.date("d/m/Y",strtotime($_GET["end"])).', for water';
          }
          else if(($_GET['bus_fil']!='true') && ($_GET['loc_fil']!='true') && ($_GET['yr_fil']!='true')){
            echo 'Real Estate Revenue Collection and Debts Summary for water';
          }
        }
      }
        ...
        if($_GET['yr2_fil']=='true'){
          ...
          echo 'CPTU Revenue Collection and Debts Summary';
        }
      }
      else if($_GET['b_type']=='Insurance'){
        if($_GET['yr2_fil']=='true'){
          echo 'UDIA Revenue Collection and Debts Summary of the Duration '.date("d/m/Y",strtotime($_GET["start2"])).' to '.date("d/m/Y",strtotime($_GET["end2"]));
        }
        else{
...
function revenuetzs(row, data, start, end, display){
  ...
  var tzs = 0;
            ...
            var NumRows = $('#spaceTable').DataTable().rows().count();
            var i, pageTotal = 0,pageTotalUsd = 0, pageTotal2 = 0, pageTotalUsd2 = 0;

            for (i = 0; i < NumRows; i++){
              var currency = api.cell(i, 5).data();
               if(currency == 'TZS'){
                 var tzs2 = intVal(api.cell(i, 6).data());
                  tzs = tzs + pageTotals;
               }
               else{
                 tzs =0;
 ...
 var table = $('#spaceTable').DataTable({
   ...
   var tablecar = $('#carTable').DataTable({
   ...
   var table_insurance = $('#insuranceTable').DataTable({
      ...
      "footerCallback": function ( row, data, start, end, display ) {
            ...
            var NumRows = $('#insuranceTable').DataTable().rows().count();
            var i, pageTotal = 0,pageTotalUsd = 0, pageTotal2 = 0, pageTotalUsd2 = 0;
        ...
        buttons: [
            {   extend: 'pdfHtml5',
                ...
                customize: function ( doc ) {
                  ...
                  doc.content[2].table.widths = [22, '*', 50, 80, 80];
                  var rowCount = doc.content[2].table.body.length;
                      for (i = 1; i < rowCount; i++) {
                         doc.content[2].table.body[i][0]=i+'.';
                      doc.content[2].table.body[i][1].alignment = 'left';

...
/*div.dt-buttons:before{ content:"\a\a";
    white-space: pre; }*/
...
@else
<br><br>
<p style="font-size: 18px;">No vehicle has been added yet.</p>
@endif
</div>
...
@else
<br><br>
<p style="font-size: 18px;">No hire rate has been added yet.</p>
@endif
</div>
...
@else
<br><br>
<p style="font-size: 18px;">No cost centre has been added yet.</p>
@endif
</div>
...
$("#check").click(function(e){
    ...
    if(query!='' && query2!=''){
      ...
      var query3 = new Date(query).toLocaleDateString('en-US', {
  day: '2-digit',
  month: '2-digit',
  year: 'numeric',
});
    var query4 = new Date(query2).toLocaleDateString('en-US', {
  day: '2-digit',
  month: '2-digit',
  year: 'numeric',
});
    ...
    .done(function(fragment) {
      ...
      var table = $('#myTable4').DataTable( {
         ...
         buttons: [
            {   extend: 'pdfHtml5',
                filename:'Available Car(s) for Hire from '+query+' to'+ query2,
                download: 'open',
                text: '<i class="fa fa-file-pdf-o"></i> PDF',
                className: 'excelButton',
                orientation: 'Potrait',
                title: 'UNIVERSITY OF DAR ES SALAAM',
                messageTop: 'DIRECTORATE OF PLANNING, DEVELOPMENT AND INVESTIMENT\n \n Available Car(s) for Hire from '+query3 +' to '+ query4,
                pageSize: 'A4',
                //layout: 'lightHorizontalLines',
                exportOptions: {
                    columns: [ 0, 1, 2, 3, 4]
        ...
        fillColor: function (rowIndex, node, columnIndex) {
          return (rowIndex % 2 === 0) ? '#ffffff' : '#ffffff';
            ...
            {   extend: 'excelHtml5',
                text: '<i class="fa fa-file-excel-o"></i> EXCEL',
                className: 'excelButton',
                title: 'Available Car(s) for Hire from '+query3 +' to '+ query4,
                exportOptions: {
                columns: [1, 2, 3, 4]
                },
            },

...
<li><a href="/system_settings"><i class="fa fa-cog pr-1" aria-hidden="true"></i>System settings</a></li>
    ...
    padding: 10px; margin-bottom: 5px; margin-top: 4px;">Add New Contract
        ...
        padding: 10px; margin-bottom: 5px; margin-top: 4px;">Add New Contract
          ...
          @if(Auth::user()->role=='Director DPDI' || Auth::user()->role=='DPDI Planner' || Auth::user()->role=='DVC Administrator')
...
@else
<td><center> <div ><span style="">{{$var->reason_for_forwarding}}</span> </div></center>  </td>
@endif
...
<a title="View Reason" style="cursor: pointer; color:#3490dc;"  class="" data-toggle="modal" data-target="#reason{{$var->contract_id}}" aria-pressed="true">View Reason</a>
...
doc.content[1].table.widths=[22, 50, 140, '*', 110,90,80,80];
var rowCount = doc.content[1].table.body.length;
for (i = 1; i < rowCount; i++) {
doc.content[1].table.body[i][0]=i+'.';

        ...
        margin-top: 4px;">
              ...
              <div class="tab">
                    ...
                    @if ($category=='CPTU only' OR $category=='All')
                        <button class="tablinks active car_identity" onclick='javascript:window.location.href="/invoice_management/car_rental"'><strong>Car Rental</strong></button>
                    @else
                    @endif
                    ...
                    <div id="car_invoices" class=""   >
                        @if(Auth::user()->role=='Accountant-DPDI' || Auth::user()->role=='Transport Officer-CPTU' || Auth::user()->role=='Head of CPTU')

                            <div id="car_invoices_inner" style="  ">
                                ...
                                @if(Auth::user()->role=='Accountant-DPDI' || Auth::user()->role=='Transport Officer-CPTU' || Auth::user()->role=='Head of CPTU')
                                    ...
                                    <div class="tab" style="">
                                        ...
                                        <button class="tablinks_inner_car " onclick="openDeepInnerCar(event, 'car_invoice_inbox')" id="defaultOpenInnerCar"><strong>Inbox</strong></button>
                                        <button class="tablinks_inner_car " onclick="openDeepInnerCar(event, 'car_invoice_outbox')"><strong>Outbox</strong></button>
                                        <button class="tablinks_inner_car " onclick="openDeepInnerCar(event, 'car_complete_invoices')"><strong>Invoices</strong></button>
                                    </div>



                                    @if(Auth::user()->role=='Accountant-DPDI')
                                        {{--                      car invoice  inbox start--}}
                                        <div  id="car_invoice_inbox" style="border-bottom-left-radius: 50px 20px;   border: 1px solid #ccc; padding: 1%;" class="tabcontent_inner_car">
                                            <br>

                                            @if($car_invoice_inbox!='')
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form method="get" action="{{ route('send_all_invoices_car')}}">
                                                                    {{csrf_field()}}

                                                                    <div align="right">
                                                                        <button id="send_all_car" class="btn btn-primary" type="submit" id="newdata">Send</button>
                                            ...
                                            @if($car_invoice_inbox!='')
                                                ...
                                                <div  id="">
                                                    ...
                                                    <table class="table">
                                                        ...
                                                        @foreach($car_invoice_inbox as $var)
                                                            <tr>
                                                                ...
                                                                <td><center>
                                                                        ...
                                                                        @if($var->email_sent_status=='NOT SENT')
                                                                            ...
                                                                            @else
                                                                                    ...
                                                                                    <div class="modal fade" id="send_invoice_car2{{$var->invoice_number}}" role="dialog">
                                                                                        ...
                                                                                        <div class="modal-dialog" role="document">
                                                                                            <div class="modal-content">
                                                                                                ...
                                                                                                <div class="modal-body">
                                                                                                    <form method="post" action="{{ route('send_invoice_car_rental_account_no',$var->invoice_number)}}"  id="form1" >
                                                                                                        {{csrf_field()}}
                                                                                                        ...
                                                                                                        @else
                                                                                                            ...
                                                                                                            <div class="form-group">
                                                                                                                <div class="form-wrapper">
                                                                                                                    <label for="account_no">Account Number</label>
                                                                                                                    <input readonly type="text" class="form-control" id="account_no" name="account_no" value="{{$var->account_no}}" Required autocomplete="off">
                                                                                                                </div>
                                                                                                            </div>
                                                                                ...
                                                                                @else
                                                                                    @if($var->gepg_control_no=='')
                                                                                        <a title="Add invoice and GePG control numbers" data-toggle="modal" style="color: #3490dc; cursor: pointer;"  data-target="#add_control_number_car{{$var->invoice_number}}"  role="button" aria-pressed="true" name="editC"><i class="fas fa-file-medical"></i></a>
                                                                                                ...
                                                                                                <div class="modal-content">
                                                                                                    ...
                                                                                                    <div class="modal-body">
                                                                                                        <form method="post" action="{{ route('add_control_no_car',$var->invoice_number)}}"  id="form1" >
                                                                                                            ...
                                                                                                            <br>
                                                                                                            <div align="right">
                                                                                                                <button id="sendbtn_car_all{{$var->invoice_number}}" class="btn btn-primary" type="submit">Save</button>
                                                                                                                <button class="btn btn-danger" type="button" class="close" data-dismiss="modal">Cancel</button>
                                                                                                            </div>
                                                                                                        </form>
                                                                                                    ...
                                                                                                    <form method="post" action="{{ route('send_invoice_car_rental',$var->invoice_number)}}"  id="form1" >
                                                                                                        ...
                                                                                                        @else
                                                                                                            <div class="form-group">
                                                                                                                <div class="form-wrapper">
                                                                                                                    <label for="course_name">GePG Control Number <span style="color: red;">*</span></label>
                                                                                                                    <input readonly type="text" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength); minControlCar(this.value,{{$var->invoice_number}});" maxlength = "12" class="form-control" id="course_name" name="gepg_control_no" value="{{$var->gepg_control_no}}" Required autocomplete="off">
                                                                                                    ...
                                                                                                    <form method="post" action="{{ route('change_payment_status_car_rental',$var->invoice_number)}}"  id="form1" >
                                                                                                        ...
                                                                                                        <div class="form-row">
                                                                                                            ...
                                                                                                            <div style="padding-top: 2%;" class="form-group col-md-12">
                                                                                                                <div class="form-wrapper">
                                                                                                                    <label for=""  >Invoice Number <span style="color: red;">*</span></label>
                                                                                                                    <input type="number" min="1" class="form-control" id="votebook_space" name="invoice_number_votebook" value="{{$var->invoice_number_votebook}}" readonly Required autocomplete="off">
                                                                                                                </div>
                                                                                                            </div>
                                                                                                            <br>
                                                        ...
                                                        @foreach($car_invoice_inbox as $var)
                                                            <tr>
                                                                ...
                                                                <td><center>
                                                                        ...
                                                                        <a  title="Forward invoice" style="color:#3490dc !important; display:inline-block;"  class="" data-toggle="modal" data-target="#invoice_foward_car{{$var->invoice_number}}" style="cursor: pointer;" aria-pressed="true"><center><i class="fas fa-arrow-alt-circle-right"></i></center></a>
                                                                        <div class="modal fade" id="invoice_foward_car{{$var->invoice_number}}" role="dialog">
                                                                            ...
                                                                            <div class="modal-dialog" role="document">
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        ...
                                                                                        <form method="post" action="{{ route('foward_car_invoice',$var->invoice_number)}}"  id="form1" >
                                                                                            {{csrf_field()}}
                                                                                            ...
                                                                                            <div align="right">
                                                                                                <button id="submit_car" class="btn btn-primary" type="submit">Foward</button>
                                                                                                <button class="btn btn-danger" type="button" class="close" data-dismiss="modal">Cancel</button>
                                                                                            </div>
                                                                                        </form>
                                    ...
                                    {{--     car invoice outbox start--}}
                                    @if(Auth::user()->role=='Transport Officer-CPTU' || Auth::user()->role=='Head of CPTU')
                                        <div  id="car_invoice_outbox" style="border-bottom-left-radius: 50px 20px;   border: 1px solid #ccc; padding: 1%;" class="tabcontent_inner_car">
                                            <br>
                                            ...
                                            @if($car_invoice_outbox!='')
                                                ...
                                                <div>
                                                    ...
                                                    <table class=" table ">
                                                        ...
                                                        @foreach($car_invoice_outbox as $var)
                                                            <tr>
                                                        ...
                                                        @foreach($car_invoice_outbox as $var)
                                                            <tr>
                                                                ...
                                                                <td><center>
                                                                        ...
                                                                        <a title="View invoice" style="color:#3490dc !important; display:inline-block; cursor: pointer;"  class="" data-toggle="modal" data-target="#invoice_car_outbox{{$var->invoice_number}}"  aria-pressed="true"><i class="fa fa-eye" style="font-size: 20px;" aria-hidden="true"></i></a>
                                                                        <div class="modal fade" id="invoice_car_outbox{{$var->invoice_number}}" role="dialog">
                                                                        ...
                                                                        <a title="View contract" style="color:#3490dc !important; display:inline-block;"  class="" data-toggle="modal" data-target="#contract_car_outbox{{$var->invoice_number}}" style="cursor: pointer;" aria-pressed="true"><i class="fa fa-file-text" aria-hidden="true"></i></a>
                                                                        <div class="modal fade" id="contract_car_outbox{{$var->invoice_number}}" role="dialog">
                                                                        ...
                                                                        @if($var->email_sent_status=='NOT SENT')
                                                                            ...
                                                                            @else
                                                                                @if($nature=='Departmental')
                                                                                    @if($var->account_no=='')
                                                                                        <a title="Add account number" data-toggle="modal" style="color: #3490dc; cursor: pointer;"  data-target="#add_account_number_car_outbox{{$var->invoice_number}}"  role="button" aria-pressed="true" name="editC"><i class="fas fa-file-medical"></i></a>
                                                                                        <div class="modal fade" id="add_account_number_car_outbox{{$var->invoice_number}}" role="dialog">
                                                                                    ...
                                                                                    <a title="Send invoice" data-toggle="modal" style=" color: #3490dc; cursor: pointer;"  data-target="#send_invoice_car2_outbox{{$var->invoice_number}}"  role="button" aria-pressed="true" name="editC"><i class="fa fa-envelope" aria-hidden="true"></i></a>
                                                                                    <div class="modal fade" id="send_invoice_car2_outbox{{$var->invoice_number}}" role="dialog">
                                                                                ...
                                                                                @else
                                                                                    @if($var->gepg_control_no=='')
                                                                                        <a title="Add invoice and GePG control numbers" data-toggle="modal" style="color: #3490dc; cursor: pointer;"  data-target="#add_control_number_car_outbox{{$var->invoice_number}}"  role="button" aria-pressed="true" name="editC"><i class="fas fa-file-medical"></i></a>
                                                                                        <div class="modal fade" id="add_control_number_car_outbox{{$var->invoice_number}}" role="dialog">
                                                                                    ...
                                                                                    <a title="Send invoice" data-toggle="modal" style=" color: #3490dc; cursor: pointer;"  data-target="#send_invoice_car_outbox{{$var->invoice_number}}"  role="button" aria-pressed="true" name="editC"><i class="fa fa-envelope" aria-hidden="true"></i></a>
                                                                                    <div class="modal fade" id="send_invoice_car_outbox{{$var->invoice_number}}" role="dialog">
                                                                        ...
                                                                        @if($var->email_sent_status=='SENT')
                                                                            ...
                                                                            @else
                                                                                ...
                                                                                @if($var->payment_status=='Not paid' AND Auth::user()->role=='Accountant-DPDI')
                                                                                    ...
                                                                                    <a title="Receive payment" data-toggle="modal" data-target="#add_comment_car_outbox{{$var->invoice_number}}"  role="button" aria-pressed="true"   name="editC"><i class="fa fa-money" style="font-size:20px; color:#3490dc !important;" aria-hidden="true"></i></a>
                                                                                    <div class="modal fade" id="add_comment_car_outbox{{$var->invoice_number}}" role="dialog">
                                    ...
                                    {{--                        car invoice outbox end--}}


                                    {{--Complete car invoices start--}}
                                    <div id="car_complete_invoices" style="border-bottom-left-radius: 50px 20px;   border: 1px solid #ccc; padding: 1%;" class="tabcontent_inner_car">
                                        {{--                                        <br>--}}

                                        {{--                                        <h3 style="text-align: center"><strong>Car invoices</strong></h3>--}}
                                                    ...
                                                    @foreach($car_invoices as $var)
                                                        <tr>
                                                            ...
                                                            <td><center>
                                                                    ...
                                                                    @if($nature=='Departmental')
                                                                        <a title="Print this invoice" href="{{ route('print_car_invoice_account',$var->invoice_number) }}"><i class="fa fa-print" aria-hidden="true"></i></a>
                                                                        ...
                                                                        <div class="modal fade" id="cancel_car_invoice{{$var->invoice_number}}" role="dialog">
                                                                            ...
                                                                            <div class="modal-dialog" role="document">
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        <form method="post" action="{{ route('cancel_car_invoice',$var->invoice_number)}}" >
                                                                                            {{csrf_field()}}
                        ...
                        @else
                            <div id="car_invoices_inner" style="border: 1px solid #ccc; padding: 1%; border-bottom-left-radius: 50px 20px; " >

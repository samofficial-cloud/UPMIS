...
<div class="main_content">
  ...
  <div class="container" style="max-width: 100%;">
    ...
    @endif
<br>
    <center><h4>{{$details->fullName}} Log Sheet to {{$details->destination}} from {{date("d/m/Y",strtotime($details->start_date))}} to {{date("d/m/Y",strtotime($details->end_date))}}</h4></center>
    <hr>
        ...
        <tbody>
          @foreach($logsheets as $log)
            <tr>
              ...
              <td><center>{{date("d/m/Y",strtotime($log->date))}}</center></td>
              <td><center>{{$log->start_time}}</center></td>
              <td style="text-align: right;">{{number_format($log->mileage_out)}}</td>
              <td><center>{{$log->closing_time}}</center></td>
              <td style="text-align: right;">{{number_format($log->mileage_in)}}</td>
              <td style="text-align: right;">{{number_format($log->mileage)}}</td>
              <td style="text-align: right;">{{number_format($log->standing_hrs)}}</td>
              <td style="text-align: right;">{{number_format($log->standing_km)}}</td>
              @if($privileges=='Read only')
              @else
              <td><center>
                        ...
                        <div class="modal-dialog modal-dialog-scrollable" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <b><h5 class="modal-title">Fill the form below to edit details</h5></b>
                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                            </div>

                            <div class="modal-body">
                              <form method="post" action="{{ route('editlogsheet') }}">
                                  {{csrf_field()}}

                                    <div class="form-group">
                                        <div class="form-wrapper">
                                          <label for="date{{$log->id}}">Date<span style="color: red;">*</span></label>
                                            <input type="date" id="date{{$log->id}}" name="date" class="form-control" required="" autocomplete="off" value="{{$log->date}}" min="{{$details->start_date}}" max="{{$details->end_date}}">
                                        </div>
                                    </div>
                                    <br>
                                    ...
                                    <div class="form-group">
                                        <div class="form-wrapper">
                                          <label for="start_time{{$log->id}}">Time Starting<span style="color: red;">*</span></label>
                                            <input type="time" id="start_time{{$log->id}}" name="start_time" class="form-control" required="" autocomplete="off" value="{{$log->start_time}}">
                                        </div>
                                    </div>
                                     <br>
                                    ...
                                    <div class="form-group">
                                        <div class="form-wrapper">
                                          <label for="mileage_out{{$log->id}}">Mileage Out<span style="color: red;">*</span></label>
                                            <input type="text" id="mileage_out{{$log->id}}" name="mileage_out" class="form-control" required="" autocomplete="off" value="{{$log->mileage_out}}" onkeypress="if((this.value.length<10)&&((event.charCode >= 48 && event.charCode <= 57) || (event.charCode==46))){return true} else return false;">
                                        </div>
                                    </div>
                                     <br>
                                    ...
                                    <div class="form-group">
                                        <div class="form-wrapper">
                                          <label for="closing_time{{$log->id}}">Time Closing<span style="color: red;">*</span></label>
                                            <input type="time" id="closing_time{{$log->id}}" name="closing_time" class="form-control" required="" autocomplete="off" value="{{$log->closing_time}}">
                                        </div>
                                    </div>
                                     <br>
                                    ...
                                    <div class="form-group">
                                        <div class="form-wrapper">
                                          <label for="mileage_in{{$log->id}}">Mileage In<span style="color: red;">*</span></label>
                                            <input type="text" id="mileage_in{{$log->id}}" name="mileage_in" class="form-control" required="" autocomplete="off" value="{{$log->mileage_in}}" onkeypress="if((this.value.length<10)&&((event.charCode >= 48 && event.charCode <= 57) || (event.charCode==46))){return true} else return false;">
                                        </div>
                                    </div>
                                     <br>
                                    ...
                                    <div class="form-group">
                                        <div class="form-wrapper">
                                          <label for="mileage{{$log->id}}">Mileage<span style="color: red;">*</span></label>
                                            <input type="text" id="mileage{{$log->id}}" name="mileage" class="form-control" required="" autocomplete="off" value="{{$log->mileage}}" onkeypress="if((this.value.length<10)&&((event.charCode >= 48 && event.charCode <= 57) || (event.charCode==46))){return true} else return false;">
                                        </div>
                                    </div>
                                     <br>
                                    ...
                                    <div class="form-group">
                                        <div class="form-wrapper">
                                          <label for="standing_hrs{{$log->id}}">Standing Charge Hours<span style="color: red;">*</span></label>
                                            <input type="text" id="standing_hrs{{$log->id}}" name="standing_hrs" class="form-control" required="" autocomplete="off" value="{{$log->standing_hrs}}" onkeypress="if((this.value.length<10)&&((event.charCode >= 48 && event.charCode <= 57) || (event.charCode==46))){return true} else return false;">
                                        </div>
                                    </div>
                                     <br>
                                    ...
                                    <div class="form-group">
                                        <div class="form-wrapper">
                                          <label for="standing_km{{$log->id}}">Standing Charge in KM<span style="color: red;">*</span></label>
                                            <input type="text" id="standing_km{{$log->id}}" name="standing_km" class="form-control" required="" autocomplete="off" value="{{$log->standing_km}}" onkeypress="if((this.value.length<10)&&((event.charCode >= 48 && event.charCode <= 57) || (event.charCode==46))){return true} else return false;">
                                        </div>
                                    </div>
                                     <br>
                 ...
                 <a title="Delete this entry" data-toggle="modal" data-target="#delete{{$log->id}}" role="button" aria-pressed="true"><i class="fa fa-trash" aria-hidden="true" style="font-size:20px; color:red; cursor: pointer;"></i></a>
                    <div class="modal fade" id="delete{{$log->id}}" role="dialog">
...
function settitle(){
   return '\n\n <?php
    echo $details->fullName.' Log Sheet to '.$details->destination.' from '.date("d/m/Y",strtotime($details->start_date)).' to '.date("d/m/Y",strtotime($details->end_date))
   ?>';
}
     ...
     var table = $('#myTable').DataTable({
         ...
         buttons: [
                {   extend: 'pdfHtml5',
                    ...
                    customize: function ( doc ) {
                      ...
                      doc.content[2].table.widths = [22, 80, 70, 70, 70, 70,70, '*', '*'];
       ...
       $("input[name='mileage_out']").blur(function(e){
          var id = e.target.id.replace(/\D/g,''),
              value=$(this).val(),
              value2= $('#mileage_in'+id).val();

              if(value!='' & value2!=''){
                var mileage = Math.abs(value2 - value);
                $('#mileage'+id).val(mileage);
                var area={!! json_encode($area) !!};
                  if(area=='Within'){
                    $('#standing_km'+id).val('0');
                  }
                  else if(area=='Outside'){
                    $('#standing_hrs'+id).val('0');
                      if(mileage > 100){
                        $('#standing_km'+id).val('10000');
                      }
                      else if(mileage<100){
                        $('#standing_km'+id).val('50000')
                      }
                  }
              }
       });

          $("input[name='mileage_in']").blur(function(e){
          var id = e.target.id.replace(/\D/g,''),
              value=$(this).val(),
              value2= $('#mileage_out'+id).val();

...
class PaymentController extends Controller
{
    ...
    public function CreateSpacePaymentManually(Request $request)
    {
        ...
        DB::table('space_payments')->insert(
            ['invoice_number' => $request->get('invoice_number'), 'invoice_number_votebook' => $request->get('invoice_number_votebook'),'amount_paid' => $request->get('amount_paid'),'amount_not_paid' =>$request->get('amount_not_paid'),'currency_payments' => $request->get('currency_payments'),'receipt_number' => $request->get('receipt_number')]
        );

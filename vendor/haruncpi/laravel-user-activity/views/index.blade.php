...
<nav class="navbar navbar-expand-sm navbar-dark color_navbar navbar-laravel" style="width: 100%">
 ...
 <h2 class=" pl-3 pt-3">User Activity Log</h2>
<hr>
    ...
    <div class="log_data_wrapper">
        ...
        <div class="responsive_table">
            <table class="table table-striped table-bordered">
                <thead style="color: #fff; background-color: #343a40 !important; border-color: #454d55;" >
                <tr>
                    <td width="30">ID</td>
                ...
                <tr ng-repeat="log in data |filter: selectedType track by $index">
                    ...
                    <td ng-switch="log.log_type">
                        ...
                        <span ng-switch-when="create" class="lbl_table">to @{{log.table_name}} table</span>
                        <span ng-switch-when="edit" class="badge warning edit_badge">@{{log.log_type}}</span>

                        <span ng-switch-when="edit|delete"
                              ng-switch-when-separator="|" class="lbl_table">to @{{ log.table_name }} table</span>

                        <span ng-switch-default class="badge debug">@{{log.log_type}}</span>
                    </td>

                    <td>
                        <strong>Name: @{{ log.user.name }}</strong><br>
                        <span class="text_light">Email: @{{ log.user.email }}</span><br>
                        <span class="text_light">Role: @{{ log.user.role }}</span>
                    </td>

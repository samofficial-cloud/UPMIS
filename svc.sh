...
SVC_NAME="actions.runner.samofficial-cloud-UPMIS.Final Deployment.service"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (samofficial-cloud-UPMIS.Final Deployment)"
